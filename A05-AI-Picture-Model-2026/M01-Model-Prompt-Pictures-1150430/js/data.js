...
不要照片寫實風，不要模糊，不要低解析度，不要文字錯亂，不要英文亂碼，不要背景雜亂，不要多餘人物，不要手腳比例錯誤，不要臉部崩壞，不要裁切到角色，不要水印，不要標誌，不要過暗，不要風格不一致，不要畫面太擁擠。",
  ...
  },
  {
    ...
    title: "個人時尚海報",
    category: "Fun",
    image: "./images/F01-Fun/F005-1.webp",
    prompt:
      "<span class='yf3'>附件照片+提示詞~</span>設計一個時尚店海報，風格像街頭風格的編輯照片一樣，模特兒(如附件圖片人物墨鏡造型)在步伐中自信地走路，穿著新季節的系列服裝，動作在戶外的燈光下呈現出動作的側面光線。使用大膽的黑色、金色和深紫色的色彩，強烈的縮寫字體，創始會員的徽章，購物袋圖標，以及「Shop the Look」CTA。應該看起來像Vogue街頭風格的拍攝，Instagram的超高解析度，戶外的廣告牌和看書手冊。",
    date: "2026-07-24",
    url: "",
  },
  {
    ...
    title: "愛好閒聊是大腦健康的證據",
    category: "Fun",
    image: "./images/F01-Fun/F005-2.webp",
    prompt:
      "<span class='yf3'>附件照片+提示詞~</span>請以 16:9 畫面比例，設計一張主題為「愛好閒聊是大腦健康的證據」的腦科學知識型資訊圖表。畫面主角沿用同一位 55 歲退休老師 Q 版人物(如附件)：短髮、戴眼鏡，表情輕鬆、愉快又帶點好奇心，穿著簡單襯衫與長褲，站在畫面左側或下方，正和一位同齡的 Q 版人物自然閒聊，兩人表情放鬆、笑容溫和，呈現出「聊得很自然、很舒服」的氛圍。背景可設計成溫馨的咖啡廳、社區座椅或書房一角，讓整體感覺親切又生活化。畫面右側與上方請分成清楚的資訊圖表區塊，用簡單圖示與短句說明主題重點。標題請置於最上方中央，文字為「愛好閒聊是大腦健康的證據」，以鋼筆字體呈現。主內容可分成三個區塊：「閒聊代表什麼」區塊：用綠色或藍綠色框出，文字重點寫「是否覺得閒聊有趣，常常反映一個人是否保有良好的社交動機與認知彈性」、「能自然參與對話、接住話題，代表注意力、理解力與反應能力仍然活躍」。可搭配對話泡泡、耳朵、腦袋與笑臉小圖示。「腦科學的觀察」區塊：用簡潔的圖表或雙人同步波形示意，文字重點寫「研究顯示，友善對話會讓大腦活動更同步，溝通更順暢」、「對話本身是一種腦力活動，會動用記憶、理解、語言與情緒調節」。可搭配兩個腦部圖示，中間用波浪線連接，表示互動時的協調感。「健康意義」區塊：用黃色或橘色作提醒，但整體仍保持溫和。文字重點寫「如果你覺得閒聊有趣，通常代表大腦仍維持良好的社交功能與精神活力」、「若對任何對話都提不起興趣，或明顯不想和人互動，則可留意睡眠、壓力、情緒或認知狀態」。這一區可搭配一個大腦、心情指標或溫度計式圖示，做出「健康亮燈」的視覺效果。整張圖請保持同一系列風格：附件Q 版人物、資訊圖表構圖、柔和暖色系、清楚分區。所有文字一律使用繁體中文，畫面中不要出現英文單字，唯有必要的專業縮寫如 AI 可保留。字體務必以鋼筆字體為主，線條簡潔，帶有手寫溫度。右下角請放置一個小型 AI 圖示作為配角，例如晶片與資料流線條結合的簡化符號，象徵這張知識圖由 AI 協助整理。整體氛圍要像一張「讓人看了會想點頭微笑」的溫暖知識圖，呈現閒聊不只是社交，也可能是大腦健康良好的表徵。",
    date: "2026-07-24",
    url: "",
  },
  {
    ...
    title: "愉快對話的理想情境",
    category: "Fun",
    image: "./images/F01-Fun/F005-3.webp",
    prompt:
      "<span class='yf3'>附件照片+提示詞~</span>請以 16:9 畫面比例，設計一張主題為「愉快對話的理想情境」的腦科學知識型資訊圖表。畫面主角為一位 55 歲退休老師的 Q 版人物，短髮、戴眼鏡，表情溫暖、放鬆又帶著理解的微笑，穿著簡單襯衫與長褲，坐在畫面一側，正與另一位年齡相近、身分對等的 Q 版人物（例如另一位同樣退休或同齡的朋友）面對面輕鬆對話，兩人姿態自然、眼神交流，呈現出「同學般平等交流」的氛圍，而不是師生或上下關係。背景可設計成溫馨的咖啡廳或書房場景，光線柔和溫暖。      畫面右側或上方請設計清楚分區的資訊圖表區塊，以視覺化方式呈現重點知識：主標題為「愉快對話的理想情境：對等的人群」，內文以精簡條列呈現：「同學之間的對話，是最理想的愉快交流情境」、「腦科學研究顯示，地位對等、關係平等的人群之間對話，會讓人感到最放鬆與舒服」、「這種舒適感來自於雙方不需要顧慮上下關係，可以自然表達與傾聽」。可以搭配一個簡化的雙人對話示意圖，例如兩個等高的對話泡泡圖示，中間用一條雙向箭頭連接，象徵「平等、雙向」的溝通關係，也可以加入簡化的腦部圖示與同步波形線條，象徵兩人在對話時大腦活動趨於一致的概念。      標題文字請置於畫面上方中央，以鋼筆字體呈現，字體溫暖又帶手寫感。所有文字一律使用繁體中文，畫面中不要出現英文單字，僅有必要的專業縮寫（如 AI）可以保留，這張主題基本上不需要用到英文縮寫。整體配色以柔和暖色調為主，例如米白、淡橘、淺木色，營造放鬆、溫馨、平等交流的氛圍，避免使用冷硬的醫療藍色系。右下角請放置一個小型 AI 圖示作為配角，例如晶片與資料流線條的簡化圖案，象徵這段知識整理是透過 AI 協助歸納呈現。   ",
    date: "2026-07-24",
    url: "",
  },
  {
    id: 355,
    title: "跟風~影子負責搞怪-老婆-1",
    category: "Fun",
    image: "./images/F01-Fun/F006-1.webp",
    prompt:
      "<span class='yf3'>附件照片+提示詞~</span>A mischievous doodle shadow mimics the character with exaggerated funny poses while she stands still wearing modern trendy clothes. The shadow appears hand-drawn, playful, and full of personality, creating a humorous contrast with the calm subject. She wears a fashionable oversized shirt, cargo pants, and sneakers. Her facial expression is confused, as if she has no idea what the shadow is doing.",
    date: "2026-07-24",
    url: "",
  },
  {
    id: 356,
    title: "跟風~影子負責搞怪-老婆-2",
    category: "Fun",
    image: "./images/F01-Fun/F006-2.webp",
    prompt:
      "<span class='yf3'>附件照片+提示詞~</span>一個調皮的塗鴉陰影用誇張的滑稽姿勢模仿這個角色，而她穿著現代時尚的衣服站著不動。 陰影看起來是手繪的，俏皮的，充滿個性，與平靜的主題形成了幽默的對比。 她穿著一件時尚的超大襯衫、工裝褲和運動鞋。 她的面部表情很困惑，好像她不知道影子在做什麼",
    date: "2026-07-24",
    url: "",
  },
  {
    id: 357,
    title: "跟風~影子負責搞怪-個人-1",
    category: "Fun",
    image: "./images/F01-Fun/F006-3.webp",
    prompt:
      "<span class='yf3'>附件照片+提示詞~</span>A mischievous doodle shadow mimics the character with exaggerated funny poses while she stands still wearing modern trendy clothes. The shadow appears hand-drawn, playful, and full of personality, creating a humorous contrast with the calm subject. She wears a fashionable oversized shirt, cargo pants, and sneakers. Her facial expression is confused, as if she has no idea what the shadow is doing.",
    date: "2026-07-24",
    url: "",
  ...
  {
    id: 358,
    title: "跟風~影子負責搞怪-個人-2",
    category: "Fun",
    image: "./images/F01-Fun/F006-4.webp",
    prompt:
      "<span class='yf3'>附件照片+提示詞~</span>一個調皮的塗鴉陰影用誇張的滑稽姿勢模仿這個角色，而她穿著現代時尚的衣服站著不動。 陰影看起來是手繪的，俏皮的，充滿個性，與平靜的主題形成了幽默的對比。 她穿著一件時尚的超大襯衫、工裝褲和運動鞋。 她的面部表情很困惑，好像她不知道影子在做什麼",
    date: "2026-07-24",
    url: "",
  },
  {
    ...
    title: "凱道反毒油遊行活動-1",
    category: "Life",
    image: "./images/L02-Life/L013-1.webp",
    prompt:
      "  請以 16:9 畫面比例，設計一張主題為「毒油食安風暴」的時事議題資訊圖表。畫面主角沿附件人物Q版墨鏡造型，，站在畫面左側或下方，手上拿著報紙或平板電腦，像是在關心閱讀這則新聞，象徵一般民眾對食安議題的關注。背景可設計成簡化的凱達格蘭大道場景或城市街景，帶一點集會人群的簡化剪影，避免呈現真實政治人物臉孔。    畫面右側與上方請設計清楚分區的資訊圖表，分成三大區塊：    1.「事件背景」區塊：說明中聯油脂爆發致癌油風暴延燒逾三週，各界要求中央公布完整成因與流向數據。可搭配一個油瓶加驚嘆號的簡化圖示。    2.「地方與中央攻防」區塊：呈現雙方主張對比，一方是台北市長蔣萬安(附件2人物Q版造型)號召725在凱道舉辦「我是人、我反毒台」大會，要求總統道歉、行政院長下台；另一方是民進黨秘書長徐國勇(附件3人物Q版造型)質疑台北市、台中市近年油品苯駢芘檢驗皆為零件，批評地方未落實查驗卻將責任推給中央。可用左右對比色塊或天平圖示呈現雙方論點的對立。    3.「後續發展」區塊：說明725當天下午5時在凱道集結，下午6時正式舉行群眾晚會，多位地方首長與黨政人士將輪番發言，呼籲政府回應食安訴求。可搭配時鐘與集會人群簡化圖示，標示「7月25日」時間點。    標題「毒油食安風暴」請置於畫面上方中央，以鋼筆字體呈現，字體莊重但不誇張。所有文字一律使用繁體中文，畫面中不要出現英文單字，僅有必要的專業縮寫（如 AI）可以保留，此主題基本不需要用到英文縮寫。整體配色以中性藍灰與暖白為主，搭配橘紅色作為警示與衝突感的點綴色，避免使用過於煽動或誇張的視覺效果，保持資訊圖表的客觀中立感。  ",
    date: "2026-07-25",
    url: "",
  },
  {
    ...
    title: "凱道反毒油遊行活動-2",
    category: "Life",
    image: "./images/L02-Life/L013-2.webp",
    prompt:
      "  請以 16:9 畫面比例，設計一張主題為「毒油食安風暴」的時事議題資訊圖表。畫面主角沿附件人物Q版墨鏡造型，，站在畫面左側或下方，手上拿著報紙或平板電腦，像是在關心閱讀這則新聞，象徵一般民眾對食安議題的關注。背景可設計成簡化的凱達格蘭大道場景或城市街景，帶一點集會人群的簡化剪影，避免呈現真實政治人物臉孔。    畫面右側與上方請設計清楚分區的資訊圖表，分成三大區塊：    1.「事件背景」區塊：說明中聯油脂爆發致癌油風暴延燒逾三週，各界要求中央公布完整成因與流向數據。可搭配一個油瓶加驚嘆號的簡化圖示。    2.「地方與中央攻防」區塊：呈現雙方主張對比，一方是台北市長蔣萬安(附件2人物Q版造型)號召725在凱道舉辦「我是人、我反毒台」大會，要求總統道歉、行政院長下台；另一方是民進黨秘書長徐國勇(附件3人物Q版造型)質疑台北市、台中市近年油品苯駢芘檢驗皆為零件，批評地方未落實查驗卻將責任推給中央。可用左右對比色塊或天平圖示呈現雙方論點的對立。    3.「後續發展」區塊：說明725當天下午5時在凱道集結，下午6時正式舉行群眾晚會，多位地方首長與黨政人士將輪番發言，呼籲政府回應食安訴求。可搭配時鐘與集會人群簡化圖示，標示「7月25日」時間點。    標題「毒油食安風暴」請置於畫面上方中央，以鋼筆字體呈現，字體莊重但不誇張。所有文字一律使用繁體中文，畫面中不要出現英文單字，僅有必要的專業縮寫（如 AI）可以保留，此主題基本不需要用到英文縮寫。整體配色以中性藍灰與暖白為主，搭配橘紅色作為警示與衝突感的點綴色，避免使用過於煽動或誇張的視覺效果，保持資訊圖表的客觀中立感。  ",
    date: "2026-07-25",
    url: "",
  },
  {
    ...
    title: "凱道反毒油遊行活動-3",
    category: "Life",
    image: "./images/L02-Life/L013-3.webp",
    prompt:
      "  請以 16:9 畫面比例，設計一張主題為「毒油食安風暴」的時事議題資訊圖表。畫面主角沿附件人物Q版墨鏡造型，，站在畫面左側或下方，手上拿著報紙或平板電腦，像是在關心閱讀這則新聞，象徵一般民眾對食安議題的關注。背景可設計成簡化的凱達格蘭大道場景或城市街景，帶一點集會人群的簡化剪影，避免呈現真實政治人物臉孔。    畫面右側與上方請設計清楚分區的資訊圖表，分成三大區塊：    1.「事件背景」區塊：說明中聯油脂爆發致癌油風暴延燒逾三週，各界要求中央公布完整成因與流向數據。可搭配一個油瓶加驚嘆號的簡化圖示。    2.「地方與中央攻防」區塊：呈現雙方主張對比，一方是台北市長蔣萬安(附件2人物Q版造型)號召725在凱道舉辦「我是人、我反毒台」大會，要求總統道歉、行政院長下台；另一方是民進黨秘書長徐國勇(附件3人物Q版造型)質疑台北市、台中市近年油品苯駢芘檢驗皆為零件，批評地方未落實查驗卻將責任推給中央。可用左右對比色塊或天平圖示呈現雙方論點的對立。    3.「後續發展」區塊：說明725當天下午5時在凱道集結，下午6時正式舉行群眾晚會，多位地方首長與黨政人士將輪番發言，呼籲政府回應食安訴求。可搭配時鐘與集會人群簡化圖示，標示「7月25日」時間點。    標題「毒油食安風暴」請置於畫面上方中央，以鋼筆字體呈現，字體莊重但不誇張。所有文字一律使用繁體中文，畫面中不要出現英文單字，僅有必要的專業縮寫（如 AI）可以保留，此主題基本不需要用到英文縮寫。整體配色以中性藍灰與暖白為主，搭配橘紅色作為警示與衝突感的點綴色，避免使用過於煽動或誇張的視覺效果，保持資訊圖表的客觀中立感。  ",
    date: "2026-07-25",
    url: "",
  },
  {
    ...
    title: "九種造型~1",
    category: "Portrait",
    image: "./images/P02-Portrait/P007-1.webp",
    prompt:
      "<span class='yf3'>利用Perplexity空間~P001-產生文章的資訊圖表提示詞產出後到Arena網站生圖~內容</span>~~1附件人物圖片Q版以照片人物為主題做出九種不同造型",
    date: "2026-07-25",
    url: "",
  },
  {
    ...
    title: "九種造型~2",
    category: "Portrait",
    image: "./images/P02-Portrait/P007-2.webp",
    prompt:
      "<span class='yf3'>利用Perplexity空間~P001-產生文章的資訊圖表提示詞產出後到Arena網站生圖~內容</span>~~1附件人物圖片Q版以照片人物為主題做出九種不同造型",
    date: "2026-07-25",
    url: "",
  },
  {
    ...
    title: "九種造型~3",
    category: "Portrait",
    image: "./images/P02-Portrait/P007-3.webp",
    prompt:
      "<span class='yf3'>利用Perplexity空間~P001-產生文章的資訊圖表提示詞產出後到Arena網站生圖~內容</span>~~1附件人物圖片Q版以照片人物為主題做出九種不同造型",
    date: "2026-07-25",
    url: "",
  },
  {
    ...
    title: "個性公仔",
    category: "Fun",
    image: "./images/F01-Fun/F007-1.webp",
    prompt:
      "請根據我們以往的對談紀錄，畫出專屬於我的人物玩具。依照平常聊天內容、興趣、個性和生活元素，設計出屬於我的公仔，並請製圖。",
    date: "2026-07-26",
    url: "",
  },
  {
    ...
    title: "與狗同框",
    category: "Fun",
    image: "./images/F01-Fun/F007-2.webp",
    prompt:
      "我和狗同框以逼真的攝影風格，用從下往上看的構圖拍攝充滿好奇心的軟綿綿的狗鼻子離鏡頭很近，佔據了畫面的大部分。 眼睛左右對稱。 拍下全身。背景是【淡粉色】，使用扭曲的超廣角鏡頭的遠近感來演出獨特的畫面效果",
    date: "2026-07-26",
    url: "",
  },
  {
    ...
    title: "日本人的15個小習慣-1",
    category: "Life",
    image: "./images/L02-Life/L014-1.webp",
    prompt:
      "標題置頂「前言：藏在日常裡的長壽秘訣」，以日系清新資訊圖表風格呈現，一位附件人物圖片轉換成Q版造型角色作為配角，站在畫面右下角微笑指引；主畫面以柔和米白與淡綠色調，分區呈現15個微型生活習慣的概念圖示（如小房間整理、太陽晨光、溫開水、散步樹林、開窗通風、書寫筆記等），搭配簡潔流程線與圖示串聯「日常微習慣→身心修復→長壽健康」的邏輯；文字全部使用繁體中文鋼筆字體，重點關鍵詞加粗放大（如「微習慣」「身心修復」「長壽」），整體風格乾淨、療癒、具有生活感與秩序感，無英文（AI例外但本圖不使用），版面平衡、閱讀動線由上而下清晰流暢。",
    date: "2026-07-27",
    url: "",
  },
  {
    ...
    title: "日本人的15個小習慣-2",
    category: "Life",
    image: "./images/L02-Life/L014-2.webp",
    prompt:
      "16:9資訊圖表設計，主標題置頂「日本人15個微習慣打造長壽生活」，畫面風格溫暖清新日系，使用柔和米色與淺綠色配色，整體以手繪感鋼筆字體呈現繁體中文文字，搭配附件人物圖片轉換為Q版可愛角色作為畫面主角，人物表情放鬆微笑，穿著居家簡約風格，站在畫面左側或中央引導視覺。    版面採「環狀＋分區圖解型資訊圖表」，將15個習慣分為五大區塊環繞角色排列，每區塊用小圖示搭配短句說明：    生活節奏區：兩分鐘法則、提早晚餐、睡前重置    晨間啟動區：晨間日光、溫水優先、開窗通風    身心恢復區：午間靜心、無目的散步、睡眠空間分離    飲食覺察區：餐前停頓、延後咖啡    空間整理區：水區清潔、物品歸位、衣物斷捨離、減少擁有    每個習慣搭配簡單線條插圖（如太陽、水杯、窗戶、床、衣服等），並附一句極短說明（6-10字），整體資訊清楚易讀。    背景加入淡淡日式居家元素（木地板、窗光、植物），營造療癒與秩序感，畫面右下角加一句小字結語：「從一個習慣開始，生活自然改變」，整體視覺乾淨、留白適中、資訊層級清晰。",
    date: "2026-07-27",
    url: "",
  },
  {
    ...
    title: "個人書桌帥氣擺設",
    category: "Life",
    image: "./images/L02-Life/L015-1.webp",
    prompt:
      "將這張照片做成列印效果的手寫塗鴉版本:畫面帶輕微陰影與紙張紋理質感,呈現真實印出來的手感。使用紅黃色原子筆手寫風格,在照片上加入大量中文讚美與崇拜感的批註塗鴉,像是「太強了吧!!」「這也太帥/美了」「膜拜」「神級表現」等誇張讚嘆語氣。搭配箭頭指向重點、圈選強調、底線標記、放大加粗的關鍵字、驚嘆號、愛心、星星、崇拜表情符號(星星眼、比讚手勢、鼓掌)。整體風格像超級粉絲或死忠好友在旁邊邊看邊尖叫讚美,語氣熱情、浮誇、真心佩服,畫面帶點雜亂但重點清楚,像忍不住手癢畫滿讚美的塗鴉筆記。",
    date: "2026-07-28",
    url: "",
  },
  {
    ...
    title: "老婆辦公桌擺設~有待加強",
    category: "Life",
    image: "./images/L02-Life/L015-2.webp",
    prompt:
      "以附件圖片為列印效果，畫面帶輕微陰影與紙張紋理。使用紅色原子筆手寫風格，在圖片上加入大量中文吐槽批註與塗鴉。包含箭頭、圈選、底線、放大重點、驚嘆號、問號、情緒表情（無語、翻白眼、問號臉）。風格像朋友或老師在旁邊邊看邊吐槽，語氣幽默、誇張、帶一點毒但不惡意攻擊。畫面稍亂但有重點，像隨手亂畫但其實很好笑的那種。",
    date: "2026-07-28",
    url: "",
  ...
  {
    id: 371,
    title: "運動與情緒的連結個人書桌帥氣擺設",
    category: "Life",
    image: "./images/L02-Life/L015-3.webp",
    prompt:
      "一張16:9資訊圖表，標題「運動 阻斷情緒惡性循環」置於畫面上方，標題文字採用鋼筆字體繁體中文書寫；主視覺為Q版退休老師人物角色站在健身房場景中央，做輕度運動動作；畫面主體以循環流程圖呈現三個階段：壓力累積、皮質醇濃度上升、運動介入後皮質醇下降並阻斷負面情緒惡性循環，各階段以箭頭連接成環狀動線；循環圖旁以簡潔圖示對比「天生不易陷入負面情緒者」與「天生容易陷入負面情緒者」兩種人物剪影，並用長條或儀表圖示呈現前者運動後幸福感提升幅度較小、後者提升幅度較大的差異；全圖文字皆為繁體中文，僅保留必要英文專業縮寫如AI字樣，字體全數採用鋼筆字體風格，畫面色調柔和溫暖，呈現健康正向的知識科普感。",
    date: "2026-07-28",
    url: "",
  },
  {
    ...
    title: "光啟同事陳成業退休-1",
    category: "Life",
    image: "./images/L02-Life/L016-1.webp",
    prompt:
      "<span class='yf3'>利用Perplexity空間~P001-產生文章的資訊圖表提示詞產出後到Arena網站生圖~</span>離職開運，飆股進潤 兄弟，今天這日子簡直是為你準備的！光榮退休，人生下半場正式開始；股市大漲，剛好送你一筆超大的『退休金』！看著滿版紅色的K線，連市場都在替你開心。前半輩子你努力打拚、辛苦存錢，後半輩子就該輕鬆享受、好好花錢。恭喜你，不但過上了好日子，還成功打敗了通膨！",
    date: "2026-07-31",
    url: "",
  },
  {
    ...
    title: "光啟同事陳成業退休-2",
    category: "Life",
    image: "./images/L02-Life/L016-2.webp",
    prompt:
      "<span class='yf3'>利用Perplexity空間~P001-產生文章的資訊圖表提示詞產出後到Arena網站生圖~</span>離職開運，飆股進潤 兄弟，今天這日子簡直是為你準備的！光榮退休，人生下半場正式開始；股市大漲，剛好送你一筆超大的『退休金』！看著滿版紅色的K線，連市場都在替你開心。前半輩子你努力打拚、辛苦存錢，後半輩子就該輕鬆享受、好好花錢。恭喜你，不但過上了好日子，還成功打敗了通膨！",
    date: "2026-07-31",
    url: "",
  },
  {
    ...
    title: "光啟同事陳成業退休-3",
    category: "Life",
    image: "./images/L02-Life/L016-3.webp",
    prompt:
      "<span class='yf3'>利用Perplexity空間~P001-產生文章的資訊圖表提示詞產出後到Arena網站生圖~</span>榮休恰遇股飄紅，半世辛勞化碩豐。笑看K線騰紫氣，餘生自在沐春風",
    date: "2026-07-31",
    url: "",
  },
  {
    ...
    title: "老婆公司驗水報告",
    category: "Life",
    image: "./images/L02-Life/L017-3.webp",
    prompt:
      "<span class='yf3'>利用Perplexity空間~P001-產生文章的資訊圖表提示詞產出後到Arena網站生圖~</span>驗水報告資料",
    date: "2026-07-31",
    url: "",
  },
  {
    id: 376,
    title: "老婆趴在地上和大狗合照~手繪風",
    category: "Life",
    image: "./images/L02-Life/L017-1.webp",
    prompt: "",
    date: "2026-07-31",
    url: "",
  },
  {
    ...
    title: "老婆趴在地上和大狗合照",
    category: "Life",
    image: "./images/L02-Life/L017-2.webp",
    prompt: "",
    date: "2026-07-31",
    url: "",
  },

  {
    ...
    title: "老婆趴在地上和大狗合照~2",
    category: "Portrait",
    image: "./images/P02-Portrait/V002-2.mp4",
    prompt:
      "溫馨互動版~「溫暖居家客廳中，戴眼鏡的女性微笑看著身旁的大型白色蓬鬆狗狗；狗狗輕輕搖尾巴、眨眼並微微吐舌，懷裡三個玩偶隨動作自然晃動。窗邊陽光緩慢流動，鏡頭輕柔推近，保留原有人物、狗狗、玩偶與水彩插畫風格，動作自然細膩。」.",
    date: "2026-07-31",
    url: "",
  },
  {
    ...
    title: "台中南投旅遊規劃-1",
    category: "Map",
    image: "./images/M01-Map/M009-1.webp",
    prompt:
      "<span class='yf3'>利用Claude產生行程之後，讓Perplexity產生圖片提示詞</span>我要到台中南投四天三夜，從台北陽明峰匯出發，住宿日月潭力麗溫德姆溫泉酒店一天，歐酷酒店(台中市中區)一天，另外一天台中3000元以內飯店，時間預計十一月底以後，你幫我規劃從台北南投搭配景點，必去的景點有蔦屋台中老佛爺和蔦屋日月町，加上台中港三井、LaLaport 台中，還有日月潭周邊景點加上南投景點，第一天可以六點出發，第四天晚上六點回家，開車自駕出發，餐點一天安排一餐當地小吃，晚餐都會以飯店餐點為主，早餐也是飯店，先規劃第一版",
    date: "2026-07-06",
    url: "",
  },
  {
    ...
    title: "台中南投旅遊規劃-2",
    category: "Map",
    image: "./images/M01-Map/M009-2.webp",
    prompt:
      "<span class='yf3'>利用Claude產生行程之後，讓Perplexity產生圖片提示詞</span>我要到台中南投四天三夜，從台北陽明峰匯出發，住宿日月潭力麗溫德姆溫泉酒店一天，歐酷酒店(台中市中區)一天，另外一天台中3000元以內飯店，時間預計十一月底以後，你幫我規劃從台北南投搭配景點，必去的景點有蔦屋台中老佛爺和蔦屋日月町，加上台中港三井、LaLaport 台中，還有日月潭周邊景點加上南投景點，第一天可以六點出發，第四天晚上六點回家，開車自駕出發，餐點一天安排一餐當地小吃，晚餐都會以飯店餐點為主，早餐也是飯店，先規劃第一版",
    date: "2026-07-06",
    url: "",
  },
  {
    ...
    title: "台中南投旅遊規劃-3",
    category: "Map",
    image: "./images/M01-Map/M009-3.webp",
    prompt:
      "<span class='yf3'>利用Claude產生行程之後，讓Perplexity產生圖片提示詞</span>我要到台中南投四天三夜，從台北陽明峰匯出發，住宿日月潭力麗溫德姆溫泉酒店一天，歐酷酒店(台中市中區)一天，另外一天台中3000元以內飯店，時間預計十一月底以後，你幫我規劃從台北南投搭配景點，必去的景點有蔦屋台中老佛爺和蔦屋日月町，加上台中港三井、LaLaport 台中，還有日月潭周邊景點加上南投景點，第一天可以六點出發，第四天晚上六點回家，開車自駕出發，餐點一天安排一餐當地小吃，晚餐都會以飯店餐點為主，早餐也是飯店，先規劃第一版",
    date: "2026-07-06",
    url: "",
  },
  {
    ...
    title: "青鳥民調~1",
    category: "Fun",
    image: "./images/F01-Fun/F008-1.webp",
    prompt:
      "16:9 橫式資訊圖表，主題為「2026台北市長選舉」，採Q版政治新聞風格，畫面以繁體中文呈現，字體以鋼筆字體為主，標題置頂且不更動；版面中央以民調數據做主視覺，使用清楚的百分比圖表與高對比色塊，呈現「沈博洋（附件1圖片Q版）93.0%」、「蔣腕安（附件2圖片Q版）2.5%」、「尚未決定 4.5%」，整體像選舉民調快訊海報，資訊分區清楚、數字醒目、視覺專業、構圖平衡、角色可愛但保有新聞感；人物請依附件照片轉為Q版角色，保留辨識特徵與神情，背景可加入台北城市意象、票箱、民調圖、上升箭頭等元素，氣氛正式、現代、具公信力，不出現英文，專業英文縮寫例外如AI。",
    date: "2026-07-31",
    url: "",
  },
  {
    ...
    title: "青鳥民調~2",
    category: "Fun",
    image: "./images/F01-Fun/F008-2.webp",
    prompt:
      "16:9 橫式資訊圖表，主題為「2062北台市長選舉」，採Q版政治新聞風格，畫面以繁體中文呈現，字體以鋼筆字體為主，標題置頂且不更動；版面中央以青鳥民調數據做主視覺，使用清楚的百分比圖表與高對比色塊，呈現「沈博洋（附件1圖片Q版）93.0%」、「蔣腕安（附件2圖片Q版）2.5%」、「尚未決定 4.5%」，整體像選舉民調快訊海報，資訊分區清楚、數字醒目、視覺專業、構圖平衡、角色可愛但保有新聞感；人物請依附件照片轉為Q版角色，保留辨識特徵與神情，背景可加入北台城市意象、票箱、民調圖、上升箭頭等元素，氣氛正式、現代、具公信力，不出現英文，專業英文縮寫例外如AI。",
    date: "2026-07-31",
    url: "",
  },
  {
    id: 384,
    title: "萬達電熱公司敦親睦鄰慶生會~當然是假的",
    category: "Fun",
    image: "./images/F01-Fun/F008-3.webp",
    prompt:
      "16:9 橫式資訊圖表，主題為「萬達電熱器公司敦親睦鄰慶生會，邀請陽明峰匯住戶一起聯誼慶生」，畫面風格可愛溫馨的Q版人物插畫，主角人物為附件人物圖片Q版，表現親切熱情的社區聯誼氛圍，場景為公司與社區聯誼慶生活動會場，有蛋糕、氣球、禮物、餐點與笑臉互動，整體呈現歡樂、友善、鄰里共融的感覺；版面採資訊圖表設計，標題放在上方最醒目位置，文字全為繁體中文，字體以鋼筆字體為主，資訊區塊清楚分層，適合活動宣傳海報風格；內容可呈現活動主題、時間：115年8月1日上午08:00-12:00、聯誼慶生活動、邀請陽明峰匯住戶參與、敦親睦鄰氛圍；畫面乾淨明亮、色彩柔和喜氣、構圖平衡、角色表情自然可愛，整體專業且具親和力，不出現英文，專業英文縮寫例外如AI。",
    date: "2026-07-31",
    url: "",
  },
  {
    ...
    title: "萬達電熱公司敦親睦鄰慶生會~當然是假的",
    category: "Fun",
    image: "./images/F01-Fun/F008-4.webp",
    prompt:
      "16:9 橫式資訊圖表，主題為「萬達電熱器公司敦親睦鄰慶生會，邀請陽明峰匯住戶一起聯誼慶生」，畫面風格可愛溫馨的Q版人物插畫，主角人物為附件人物圖片Q版，表現親切熱情的社區聯誼氛圍，場景為公司與社區聯誼慶生活動會場，有蛋糕、氣球、禮物、餐點與笑臉互動，整體呈現歡樂、友善、鄰里共融的感覺；版面採資訊圖表設計，標題放在上方最醒目位置，文字全為繁體中文，字體以鋼筆字體為主，資訊區塊清楚分層，適合活動宣傳海報風格；內容可呈現活動主題、時間：115年7月31日中午12:00、聯誼慶生活動、邀請陽明峰匯住戶參與、敦親睦鄰氛圍；畫面乾淨明亮、色彩柔和喜氣、構圖平衡、角色表情自然可愛，整體專業且具親和力，不出現英文，專業英文縮寫例外如AI。",
    date: "2026-07-31",
    url: "",
  },
  {
    id: 386,
    title: "萬達電熱公司敦親睦鄰慶生會~現場照片的",
    category: "Fun",
    image: "./images/F01-Fun/F008-5.webp",
    prompt:
      "<span class='yf3'>利用Claude產生行程之後，讓Perplexity產生圖片提示詞</span>以附件1圖片門口為辦理敦親睦鄰慶生會場地，附件2圖片為本次活動海報大門擁擠站滿了要前往參加慶生會的陽明峰匯社區民眾，門口也準備了很多慶生會的桌椅餐點，門口還有此次f慶生的氣球拱門，非常歡樂的畫面，圖片16:9比例，以真實相片實際模式呈現，如有字體需求以繁體中文呈現",
    date: "2026-07-31",
    url: "",
  },
  {
    ...
    title: "萬達電熱公司敦親睦鄰慶生會~現場照片的",
    category: "Fun",
    image: "./images/F01-Fun/F008-6.webp",
    prompt:
      "<span class='yf3'>利用Claude產生行程之後，讓Perplexity產生圖片提示詞</span>以附件1圖片門口為辦理敦親睦鄰慶生會場地，附件2圖片為本次活動海報大門擁擠站滿了要前往參加慶生會的陽明峰匯社區民眾，門口也準備了很多慶生會的桌椅餐點，門口還有此次f慶生的氣球拱門，非常歡樂的畫面，圖片16:9比例，以真實相片實際模式呈現，如有字體需求以繁體中文呈現",
    date: "2026-07-31",
    url: "",
  },
  {
    ...
    title: "58.5歲",
    category: "Life",
    image: "./images/L02-Life/L018-1.webp",
    prompt:
      "一晃眼，五十八歲半就這麼溜走，離五十九歲只差半步啦、16:9 畫面比例，整體版面以溫暖、幽默又帶點自嘲的資訊圖表呈現「五十八歲半退休生活感悟」，畫面上方置中放標題「一晃眼，五十八歲半就這麼溜走，離五十九歲只差半步啦」，字體為自然流暢的鋼筆字體，帶有手寫日記感  主色採用溫暖的米色、咖啡色與柔和的橘紅，營造人生下半場的沉穩與溫度，背景可加入淡淡時鐘刻度、年輪或日曆翻頁的紋理，象徵時間悄悄流逝  畫面中央以「這半年，我發現……」為小標題，用四個資訊卡片呈現身體與生活的變化，每一項搭配小圖示與鋼筆字體文字：  「體力越來越差」旁：電池电量降低或爬坡喘氣的小人圖示  「記性越來越容易忘記」旁：大腦加問號或便條紙飛走的圖示  「體重數字越來越多」旁：體重計與向上箭頭，旁邊加一個可愛的「隨身保暖包」小標籤  「血壓越來越高、腦子轉得慢」旁：血壓計與慢慢轉動的齒輪圖示  在這四個卡片下方，用一個溫柔的框框寫上結論語句：「剛好讓腳步也慢下來，減不下來的肉，就當是歲月給的隨身保暖包吧！反正只要人還在，學到老，笑到老，這半歲，賺到了！」字體稍大、筆畫略粗，作為整張圖的情感核心  在畫面右下角安排一位可愛的附件人物 Q 版造型角色，穿著休閒居家服裝，一手摸頭、一手扶腰，表情有點無奈但又帶著微笑，身邊可以放一個小標籤寫著「隨身保暖包」，增添幽默與親和力  所有文字與標示皆為繁體中文，不出現一般英文單字，整體風格溫暖、真實、帶點幽默自嘲，適合作為退休中段年紀的自我對話與生活紀錄圖  ",
    date: "2026-07-31",
    url: "",
  },
  {
    ...
    title: "個人時尚雜誌封面",
    category: "Portrait",
    image: "./images/P02-Portrait/P008-1.webp",
    prompt:
      "參考圖片人物，完整保留人物的臉部五官、臉型、髮型、膚色、身形比例與個人氣質，不改變人物身份，保持真實自然。製作一張國際精品時尚雜誌封面。風格：VOGUE、ELLE、Harper's BAZAAR、GQ、Esquire 等級高端時尚攝影，Premium Editorial Photography，Luxury Fashion Magazine Cover，電影級光影，超寫實。構圖：9:16 直式封面，全身或四分之三身。人物站立或自然倚靠現代建築、精品空間或極簡背景，自信且從容地直視鏡頭，展現優雅、自信與時尚氣質。服裝：高級訂製時裝（Haute Couture）、精品西裝、精品套裝、長版外套、洋裝、亞麻服飾、精品休閒服等，依人物氣質自動搭配最適合的國際精品造型，布料細節精緻，剪裁俐落。配件：精品腕錶、戒指、項鍊、耳環、墨鏡或皮件，依整體造型自然搭配，低調奢華，不過度誇張。背景：現代建築、城市天際線、精品攝影棚或極簡藝術空間，背景柔焦，營造高級時尚氛圍。封面刊頭：OLD MU 主標題：STYLE NEVER FADES 副標題：",
    date: "2026-08-02",
    url: "",
  },
  {
    id: 390,
    title: "老婆和自己的Q版卡通人物合照",
    category: "Portrait",
    image: "./images/P02-Portrait/P008-3.webp",
    prompt:
      "真人女生和Q版卡通自己牽手合照，女生保留原圖棕色高丸子頭髮色，身穿淺藍牛仔外套、白色內搭、毛邊牛仔短褲、白色堆堆襪與厚底小白鞋，一隻手插在褲兜溫柔微笑。右側是同穿搭同款髮型的誇張大頭Q版塗鴉女孩，wink吐舌頭比出剪刀手，單腳抬起。背景是街頭水泥塗鴉牆，滿屏繽紛潑漆顏料、粉色愛心、五角星、小彩虹、皇冠街頭塗鴉元素，美式波普塗鴉風格，寫實人像+美式漫畫塗鴉融合攝影，自然光街拍，竪版構圖，清晰細膩膚質，8K高清，街頭活力甜酷氛圍",
    date: "2026-08-02",
    url: "",
  },
  {
    id: 391,
    title: "個人和自己的Q版卡通人物合照",
    category: "Portrait",
    image: "./images/P02-Portrait/P008-2.webp",
    prompt:
      "真人男生和Q版卡通自己牽手合照，男生保留原圖穿著，一隻手插在褲兜溫柔微笑。右側是同穿搭同款髮型的誇張大頭Q版塗鴉男孩，wink吐舌頭比出剪刀手，單腳抬起。背景是街頭水泥塗鴉牆，滿屏繽紛潑漆顏料、粉色愛心、五角星、小彩虹、皇冠街頭塗鴉元素，美式波普塗鴉風格，寫實人像+美式漫畫塗鴉融合攝影，自然光街拍，竪版構圖，清晰細膩膚質，8K高清，街頭活力甜酷氛圍",
    date: "2026-08-02",
    url: "",
  },
  {
    id: 392,
    title: "和GPT聊天一陣子他對我的了解-1",
    category: "Personal",
    image: "./images/P04-Personal/P002-1.webp",
    prompt:
      "依據你對我的所有了解，製作一張關於我和我工作的漫畫。根據我們這段時間的交流，我會將漫畫設計成類似下面的內容：  退休老師：站在黑板前，學生向你揮手道別，象徵教學生涯。  終身學習者：坐在電腦前研究 ChatGPT、AI 工具、網頁設計（Vue、HTML、Python）。  閱讀人生：四周堆滿你喜歡的書籍，旁邊有咖啡與筆記本。  健康生活：清晨在關渡河岸散步，迎著日出。  家庭支持：與兒子討論健身教練工作，分享職場建議。  退休新人生：將學習成果整理成美觀的網頁，螢幕上顯示「退休不退化」「終身學習」等主題。  未來夢想：背景有日本地圖、TOEIC、AI Agent、全端開發等元素，代表你的下一階段目標。  整體風格我會採用：  手繪漫畫＋溫暖療癒色彩  淺藍、米黃配色  鋼筆字手寫標題  幽默又勵志，像一本「我的退休第二人生」漫畫封面 ",
    date: "2026-08-02",
    url: "",
  },
  {
    id: 393,
    title: "和GPT聊天一陣子他對我的了解-2",
    category: "Personal",
    image: "./images/P04-Personal/P002-2.webp",
    prompt:
      "依據你對我的所有了解，製作一張關於我和我工作的漫畫。根據我們這段時間的交流，我會將漫畫設計成類似下面的內容：  退休老師：站在黑板前，學生向你揮手道別，象徵教學生涯。  終身學習者：坐在電腦前研究 ChatGPT、AI 工具、網頁設計（Vue、HTML、Python）。  閱讀人生：四周堆滿你喜歡的書籍，旁邊有咖啡與筆記本。  健康生活：清晨在關渡河岸散步，迎著日出。  家庭支持：與兒子討論健身教練工作，分享職場建議。  退休新人生：將學習成果整理成美觀的網頁，螢幕上顯示「退休不退化」「終身學習」等主題。  未來夢想：背景有日本地圖、TOEIC、AI Agent、全端開發等元素，代表你的下一階段目標。  整體風格我會採用：  手繪漫畫＋溫暖療癒色彩  淺藍、米黃配色  鋼筆字手寫標題  幽默又勵志，像一本「我的退休第二人生」漫畫封面 ",
    date: "2026-08-02",
    url: "",
  ...
  {
    id: 394,
    title: "和GPT聊天一陣子他對我的了解-3",
    category: "Personal",
    image: "./images/P04-Personal/P002-3.webp",
    prompt:
      "依據你對我的所有了解，製作一張關於我和我工作的漫畫。根據我們這段時間的交流，我會將漫畫設計成類似下面的內容：  退休老師：站在黑板前，學生向你揮手道別，象徵教學生涯。  終身學習者：坐在電腦前研究 ChatGPT、AI 工具、網頁設計（Vue、HTML、Python）。  閱讀人生：四周堆滿你喜歡的書籍，旁邊有咖啡與筆記本。  健康生活：清晨在關渡河岸散步，迎著日出。  家庭支持：與兒子討論健身教練工作，分享職場建議。  退休新人生：將學習成果整理成美觀的網頁，螢幕上顯示「退休不退化」「終身學習」等主題。  未來夢想：背景有日本地圖、TOEIC、AI Agent、全端開發等元素，代表你的下一階段目標。  整體風格我會採用：  手繪漫畫＋溫暖療癒色彩  淺藍、米黃配色  鋼筆字手寫標題  幽默又勵志，像一本「我的退休第二人生」漫畫封面 ",
    date: "2026-08-02",
    url: "",
  },
  {
    ...
    title: "115年8月份聚餐規劃-1",
    category: "Life",
    image: "./images/L02-Life/L019-3.webp",
    prompt:
      "<span class='yf3'>利用Perplexity空間~P001-產生文章的資訊圖表提示詞產出後到Arena網站生圖~內容</span>三張附件照片，40年好友聚餐，餐點標題如下【熱鬧滾滾，就是爽啦！】豬腳便當軟爛爛，黑松沙士有夠香冰箱裡罐裝啤酒，大夥喝到有夠爽萬家福仙草紅豆，吃完心肝不發慌咖啡配餅乾派加，宜蘭蔥餅真夠香",
    date: "2026-08-04",
    url: "",
  },
  {
    ...
    title: "115年8月份聚餐規劃-2",
    category: "Life",
    image: "./images/L02-Life/L019-4.webp",
    prompt:
      "<span class='yf3'>利用Perplexity空間~P001-產生文章的資訊圖表提示詞產出後到Arena網站生圖~內容</span>三張附件照片，40年好友聚餐，餐點標題如下【熱鬧滾滾，就是爽啦！】豬腳便當軟爛爛，黑松沙士有夠香冰箱裡罐裝啤酒，大夥喝到有夠爽萬家福仙草紅豆，吃完心肝不發慌咖啡配餅乾派加，宜蘭蔥餅真夠香",
    date: "2026-08-04",
    url: "",
  },
  {
    ...
    title: "115年8月份聚餐規劃-3",
    category: "Life",
    image: "./images/L02-Life/L019-1.webp",
    prompt:
      "<span class='yf3'>利用Perplexity空間~P001-產生文章的資訊圖表提示詞產出後到Arena網站生圖~內容</span>三三位(附件三張人物圖片Q版)造型相識超過四十年的好友聚會，八月到家裡聚會，餐點如下~正餐~商城的好吃豬腳飯+黑松沙士+冰箱滿滿的各類罐裝啤酒飯後甜點~萬家福仙草冰下午茶~YFC咖啡+好市多夾心餅乾+好市多巧克力夾心派+宜蘭蔥餅一起度過愉快八月某一天下午",
    date: "2026-08-04",
    url: "",
  },
  {
    ...
    title: "115年8月份聚餐規劃-3",
    category: "Life",
    image: "./images/L02-Life/L019-2.webp",
    prompt:
      "<span class='yf3'>利用Perplexity空間~P001-產生文章的資訊圖表提示詞產出後到Arena網站生圖~內容</span>三三位(附件三張人物圖片Q版)造型相識超過四十年的好友聚會，八月到家裡聚會，餐點如下~正餐~商城的好吃豬腳飯+黑松沙士+冰箱滿滿的各類罐裝啤酒飯後甜點~萬家福仙草冰下午茶~YFC咖啡+好市多夾心餅乾+好市多巧克力夾心派+宜蘭蔥餅一起度過愉快八月某一天下午",
    date: "2026-08-04",
    url: "",
  ...
  {
    id: 399,
    title: "115年8月份聚餐菜色更改-1",
    category: "Life",
    image: "./images/L02-Life/L020-1.webp",
    prompt:
      "請生成一張16:9橫向資訊圖表（infographic），主題標題「網軍伙食：薛丁格的承諾」，標題完整呈現於畫面正上方，字體為手寫鋼筆字體，全篇文字皆為繁體中文。      整體採用「今昔對比／異動對照」型資訊圖表，畫面分為左右兩大區塊：左側標示「週一版本」，右側標示「週二版本」，中間以一個半開的方形箱子（象徵薛丁格的箱子）連接兩側，箱子上以鋼筆手寫字體寫著「薛丁格的承諾」，象徵承諾隨時可能改變。      左側週一版本由上至下以四個項目卡呈現：   一、正餐：豬腳飯與黑松沙士插畫圖示   二、下酒：滿滿一整排罐裝啤酒的冰箱插畫   三、飯後甜點：仙草冰插畫   四、下午茶：咖啡、夾心餅乾、巧克力派、蔥餅四種點心插畫並列      右側週二版本同樣以四個項目卡呈現，變動項目加上鋼筆手寫「大風吹」印章效果強調：   一、正餐：原豬腳飯插畫被鋼筆劃上一道斜線，旁邊改為鍋貼插畫，黑松沙士保留不變   二、下酒：啤酒罐插畫由「滿滿一冰箱」改為「兩罐裝在提袋中」，並標註手寫小字「喝酒不開車」   三、飯後甜點：仙草冰插畫維持不變，加上鋼筆手寫小標籤「唯一不變的溫柔」   四、下午茶：四種點心插畫完全保留不變，同樣加上「不變」小標籤      畫面下方或角落安排一位Q版人物（依附件圖片中人物的Q版造型呈現，作為配角），姿態俏皮，一手指向中間的薛丁格箱子，表情帶點無奈又搞笑。人物旁加上一句鋼筆手寫金句：「變來變去，啤酒只會越變越多」。      整體色調活潑清爽，插畫風格卡通可愛，圖示簡潔明瞭。畫面中不可出現任何英文字母，品牌名稱以中文方式呈現（例如咖啡、罐裝啤酒），僅專業英文縮寫如AI可例外（本圖無需使用）。版面排版整潔、資訊層級分明：主標題最大、分類標籤次之、細節文字最小，全程使用繁體中文與鋼筆字體呈現。   ",
    date: "2026-08-05",
    url: "",
  },
  {
    id: 400,
    title: "115年8月份聚餐菜色更改-2",
    category: "Life",
    image: "./images/L02-Life/L020-2.webp",
    prompt:
      "請生成一張16:9橫向資訊圖表（infographic），主題標題「網軍伙食：薛丁格的承諾」，標題完整呈現於畫面正上方，字體為手寫鋼筆字體，全篇文字皆為繁體中文。      整體採用「今昔對比／異動對照」型資訊圖表，畫面分為左右兩大區塊：左側標示「週一版本」，右側標示「週二版本」，中間以一個半開的方形箱子（象徵薛丁格的箱子）連接兩側，箱子上以鋼筆手寫字體寫著「薛丁格的承諾」，象徵承諾隨時可能改變。      左側週一版本由上至下以四個項目卡呈現：   一、正餐：豬腳飯與黑松沙士插畫圖示   二、下酒：滿滿一整排罐裝啤酒的冰箱插畫   三、飯後甜點：仙草冰插畫   四、下午茶：咖啡、夾心餅乾、巧克力派、蔥餅四種點心插畫並列      右側週二版本同樣以四個項目卡呈現，變動項目加上鋼筆手寫「大風吹」印章效果強調：   一、正餐：原豬腳飯插畫被鋼筆劃上一道斜線，旁邊改為鍋貼插畫，黑松沙士保留不變   二、下酒：啤酒罐插畫由「滿滿一冰箱」改為「兩罐裝在提袋中」，並標註手寫小字「喝酒不開車」   三、飯後甜點：仙草冰插畫維持不變，加上鋼筆手寫小標籤「唯一不變的溫柔」   四、下午茶：四種點心插畫完全保留不變，同樣加上「不變」小標籤      畫面下方或角落安排一位Q版人物（依附件圖片中人物的Q版造型呈現，作為配角），姿態俏皮，一手指向中間的薛丁格箱子，表情帶點無奈又搞笑。人物旁加上一句鋼筆手寫金句：「變來變去，啤酒只會越變越多」。      整體色調活潑清爽，插畫風格卡通可愛，圖示簡潔明瞭。畫面中不可出現任何英文字母，品牌名稱以中文方式呈現（例如咖啡、罐裝啤酒），僅專業英文縮寫如AI可例外（本圖無需使用）。版面排版整潔、資訊層級分明：主標題最大、分類標籤次之、細節文字最小，全程使用繁體中文與鋼筆字體呈現。   ",
    date: "2026-08-05",
    url: "",
  },
  {
    ...
    title: "AI甲級詐騙規劃師-1",
    category: "Life",
    image: "./images/L02-Life/L020-3.webp",
    prompt: "~提示詞不好說",
    date: "2026-08-05",
    url: "",
  },
  {
    ...
    title: "AI甲級詐騙規劃師-1",
    category: "Life",
    image: "./images/L02-Life/L020-4.webp",
    prompt: "~提示詞不好說",
    date: "2026-08-05",
    url: "",
  },
  {
    ...
    title: "AI甲級詐騙規劃師-1",
    category: "Life",
    image: "./images/L02-Life/L020-5.webp",
    prompt: "~提示詞不好說",
    date: "2026-08-05",
    url: "",
  },
  {
    ...
    title: "工作壓力太大-1",
    category: "Fun",
    image: "./images/F01-Fun/F009-1.webp",
    prompt:
      "一場精緻的超現實迷你攝影場景，呈現了與參考圖像一致的細膩成人女性特徵、柔和髮型與溫婉比例。她僅有 8 到 10 公分高，與超大型的日常辦公室物品互動，演繹出既幽默又令人感同身受的「過勞辦公族」主題。      場景 1： 小女人蜷縮在巨大筆記型電腦的鍵盤上安靜沉睡，身後螢幕滿是巨大的商業圖表。   場景 2： 她癱倒在巨大的辦公椅上睡著了，一條領帶滑落蓋住眼睛，宛如臨時眼罩，一旁是尺寸懸殊的馬克杯。   場景 3： 她在散落的巨大辦公室文件堆上放鬆，任由紙張飄飛，充分展現出徹底筋疲力盡的模樣。   場景 4： 她緊張地攀附在巨大的電腦滑鼠上，而一隻巨大的人類手掌正操控滑鼠移動，她臉上的擔憂表情製造出強烈的趣味尺寸反差。   場景 5： 她懸掛在巨大的掛鐘指針上，奮力支撐，彷彿時間本身正拖著她熬過整個工作日。   場景 6： 她窩進一個巨大的迴紋針內部，將它當作小床，伴隨著超大的待辦清單表格，在長時間工作後稍作歇息。      超現實的宏觀特寫（100mm 鏡頭）、電影級敘事構圖、真實世界紋理、超細膩細節、HDR、8K 解析度、柔美散景效果、寫實光影與陰影、高級微縮模型質感、幽默的辦公室生活意涵。無文字、無浮水印，垂直 2:3 構圖。   ",
    date: "2026-08-05",
    url: "",
  },
  {
    ...
    title: "工作壓力太大-1",
    category: "Fun",
    image: "./images/F01-Fun/F009-2.webp",
    prompt:
      "一場精緻的超現實迷你攝影場景，呈現了同樣的精細成人男性特徵，髮型、髮髻和比例與參考圖像一致。他只有8-10厘米高，與超大日常辦公室物品互動，具有幽默且可感性的「過度工作辦公室生活」主題。電影般的敘事、真實的CGI、高級迷你地圖、宏偉的攝影、微弱的場景深度、柔和的溫暖辦公室照明、真實的紋理、自然的皮膚細節、表達性的面部情緒、微小的休閒夏季服裝（T恤、短褲、白色運動鞋）、所有場景中的角色身份一致。 場景1：小男人在巨大的筆記本電腦鍵盤上安靜地睡覺，巨大的商業圖表填滿了螢幕後方。 場景2：他在巨大的辦公室椅子上睡著了，戴著一條滑落在眼睛上像睡眠面具一樣的領帶，旁邊有一個巨大的咖啡杯。 場景3：他在巨大的辦公室文件堆上放鬆，隨著寬鬆的紙張飛舞，看到他完全筋疲力盡。 場景4：他緊緊抓住巨大的電腦鼠標，巨大的人類手在它上移動，他的擔憂表情創造出一個有趣的尺寸感。 場景5：他掛在巨大的牆上的時鐘上，努力保持住，好像時間本身正在拖著他穿過工作日。 場景6：他躺在巨大的紙clip內，使用它作為一張長時間工作的筆記本清單檢查表格，使用它作為一張小床，長時間的工作後。 超現實的宏偉鏡頭（100mm）、電影般的構圖、真實世界的紋理、超細節、HDR、8K、柔和的波克、真實的陰影、真實的陰影、高級迷你工藝、幽默的辦公室生活概念、無文字、無水印，垂直2:3構圖。 ",
    date: "2026-08-05",
    url: "",
  },
  {
    id: 406,
    title: "玄衡客 · 觀局策士角色能力檔案-1",
    category: "Fun",
    image: "./images/F01-Fun/F010-1.webp",
    prompt:
      "一請根據使用者在過往對話中呈現的性格、興趣、思考方式、處事風格與個人特質，推演如果此人穿越進入金庸武俠小說世界，最適合發展的武功、內功、身法、戰鬥風格與江湖定位。 請製作一張「金庸武俠 RPG 角色能力設定圖」，採用高質感古典武俠遊戲角色資料卡風格。 重要要求 - 不要顯示使用者的真實姓名 - 不要顯示出生地、出身背景 - 不要顯示生日、出生時間等個人資料 - 不要自行捏造真實身份資訊 - 可以使用使用者在對話中展現的性格與興趣作為推演依據 - 如果使用者沒有提供某項資料，請不要自行補充真實資料 角色設定 請分析使用者最適合的： 1. 核心武學 - 選擇 4～6 種最適合的金庸武學 - 可以包含內功、掌法、劍法、指法、輕功、特殊技 - 不要單純因為武功強大就選擇，必須解釋為什麼與使用者性格契合 2. 武功修為 - 每項武功給予 1～5 星 - 顯示修煉特色與戰鬥用途 3. 綜合能力值 使用 100 分制： - 內力修為 - 武功招式 - 身法輕功 - 智慧謀略 - 觀察洞察 - 人際魅力 ",
    date: "2026-08-17",
    url: "",
  },
  {
    ...
    title: "結婚紀念-1",
    category: "Life",
    image: "./images/L02-Life/L021-1.webp",
    prompt:
      "在上傳的夫婦的照片中，製作一個可愛的高級3D動畫收藏人偶場景。將他們轉化為一個可愛的丈夫和妻子，站在一個小圓形展示基上。保留他們可識別的年齡、面部特徵、髮型、眼鏡（如果有），皮膚色和溫暖的愛情表情，但將他們呈現出一個柔軟的皮克斯風格/粘土玩具人偶的外觀。     男人站在左邊，帶著溫柔的微笑，一隻手愛著女人的肩膀，女人的右邊站著，微笑著溫暖地向他看。他們的姿勢應該感覺溫暖、平靜和終身浪漫。兩位元主題人物應該看起來真實，而不是通用西方的服裝。例如，用文化相關的服裝、層疊、圖案、珠寶和整體造型來裝飾，他們的服裝應該符合他們的文化背景，並且在視覺上保持和諧。     服裝應該與夫婦的文化相符，而不是通用西方的服裝。例如，用可愛的金色文字在圓形基上列印：【自從2000年以來就結婚了】，【永峯】和【文慈】在圓形基上，添加優雅的金色文字：【無盡的❤️愛】。將人偶放在木頭桌子上，前面有溫暖的燈光，淺層的視野深度，高級的迷你戲劇感，柔軟的陰影，木頭玩具般的質地，詳細的布料和真實的燈光。     保持構圖的中心，溫暖、真實、乾淨和像禮物一樣。方形比例1:1。  ",
    date: "2026-08-17",
    url: "",
  },
  {
    ...
    title: "結婚紀念-2",
    category: "Life",
    image: "./images/L02-Life/L021-2.webp",
    prompt:
      "在上傳的夫婦的照片中，製作一個可愛的高級3D動畫收藏人偶場景。將他們轉化為一個可愛的丈夫和妻子，站在一個小圓形展示基上。保留他們可識別的年齡、面部特徵、髮型、眼鏡（如果有），皮膚色和溫暖的愛情表情，但將他們呈現出一個柔軟的皮克斯風格/粘土玩具人偶的外觀。     男人站在左邊，帶著溫柔的微笑，一隻手愛著女人的肩膀，女人的右邊站著，微笑著溫暖地向他看。他們的姿勢應該感覺溫暖、平靜和終身浪漫。兩位元主題人物應該看起來真實，而不是通用西方的服裝。例如，用文化相關的服裝、層疊、圖案、珠寶和整體造型來裝飾，他們的服裝應該符合他們的文化背景，並且在視覺上保持和諧。     服裝應該與夫婦的文化相符，而不是通用西方的服裝。例如，用可愛的金色文字在圓形基上列印：【自從2000年以來就結婚了】，【永峯】和【文慈】在圓形基上，添加優雅的金色文字：【無盡的❤️愛】。將人偶放在木頭桌子上，前面有溫暖的燈光，淺層的視野深度，高級的迷你戲劇感，柔軟的陰影，木頭玩具般的質地，詳細的布料和真實的燈光。     保持構圖的中心，溫暖、真實、乾淨和像禮物一樣。方形比例1:1。  ",
    date: "2026-08-17",
    url: "",
  },
  {
    ...
    title: "咖啡人生，大小自我-1",
    category: "Mini",
    image: "./images/M02-Mini/M005-1.webp",
    prompt:
      "根據提供的參考圖片，創建一個高度細緻的超現實電影式微幻想照片。保留主人的臉部特徵、髮型、鬍子、膚色和整體外觀的準確描述。    一名普通尺寸的男子舒適地坐在一個溫暖舒適的臥室裡，穿著一件簡單的黑色T恤。他一隻手拿著一個大型陶瓷咖啡杯，另一隻手放置在頭上，微笑著，表情沉重、放鬆的週末表情。    在他面前，木桌子上，有一個微小的指數尺寸的同樣男子的迷你版本，約長度為10-12厘米，坐在一個美麗細緻的迷你木床上。迷你男子穿著完全不同的休閒早晨服裝：一件輕灰色的泰迪熊T恤和藍色格子睡衣褲。他正在劇烈地打哈欠並將雙臂向上伸展，好像剛醒來一樣，背景上有著誇張的昏昏欲睡和搞笑的表情。    迷你床上有一個小小的藍色毯子、小小的枕頭、小型的木製梯子和一個小小的復古鬧鐘旁邊。迷你床旁邊有一個小板，寫著【週末模式】，下面有個簡單的綠色ON開關。文字必須是乾淨的、正確的、可讀的，並且自然地融入到場景中。    左側桌子上，包括一個盤子上有幾個早餐餅乾/餅乾。巨大的咖啡杯應該佔領前景，強調正常尺寸男子和迷你角色之間的極端尺寸差異。    溫暖的金色早晨陽光穿過臥室窗戶，創造出美麗的自然高光和柔和的陰影。舒適的木製內部，真實的家具，微妙的背景植物，電影般的深度，真實的皮膚孔隙，細緻的布料纖維，真實的木材質，物理準確的迷你尺寸，真實的反射，自然的陰影。    構圖：垂直 4:5 人像，電影式的框架，低桌面視角，正常尺寸的人在上方背景中明顯可見，微縮人物和床在前景中中間明顯可見，左邊是巨大的咖啡杯，右邊是復古的鬧鐘，強烈的視覺敘事和誇張的比例對比。    風格：超真實的攝影，電影式的宏偉攝影，超細節的真實微縮攝影，自然的人體解剖，真實的面部表情，溫暖的早晨光線，浅深的景深，微妙的波凸，高動態範圍，專業攝影，8K細節。    重要：微縮人物必須看起來像一個真實的小人，而不是玩具、娃娃、雕像、卡通或CGI人物。保持對比的尺寸實在且可信，並維持所有物體之間的真實互動。不要添加額外的人、複製人物、扭曲的手、不合理的面孔、漂浮的物體或不必要的文字。  ",
    date: "2026-08-17",
    url: "",
  },
  {
    ...
    title: "咖啡人生，大小自我-1",
    category: "Mini",
    image: "./images/M02-Mini/M005-2.webp",
    prompt:
      "超現實的電影式迷你攝影，夜間的溫暖舒適客廳。一個巨大的黑色T恤穿著的人舒適地坐在背景的沙發上，向前傾斜，面向下，帶著溫和、昏昏的微笑。前景上，一張黑色打磨的木桌子上，一個只有幾英寸高的小人坐在桌子旁邊，邊緣上放著一個巨大的Nescafé 3-in-1 sachet，將 sachet 用作背靠。他的頭部略大，面部特徵真實，短髮，鬍子短，黑色深綠色過膚衫，灰色T恤，棕色褲子和白色運動鞋。他的雙臂交叉著，而他的眼睛閉著，彷彿在睡著。     一個大型陶瓷咖啡杯站在他旁邊，與小人相比非常誇張地超大。小人堆積的咖啡粒自然地散落在木桌子附近。Nescafé sachet 站立著，略微傾斜，清楚可辨認，具有真實的包裝和可讀的「NESCAFÉ 3 in 1」品牌標誌。小人必須完全站在 sachet 前面，而不是在裡面，也不能在不自然的情況下重叠。     溫暖的橙色桌燈照明，溫暖的夜間氛圍，真實的陰影，電影般的深度，超細節，8K，垂直構圖，不包含卡通，不包含玩具般的外觀，不包含幻想插圖。    ",
    date: "2026-08-17",
    url: "",
  },
  {
    ...
    title: "失敗主管的六大習慣-1",
    category: "Principle",
    image: "./images/P04-principle/Pr003-1.webp",
    prompt: "<span class='yf3'>到了退休才知道當年主管幹不久的原因~非提示詞",
    date: "2026-08-17",
    url: "",
  },
  {
    ...
    title: "失敗主管的六大習慣-2",
    category: "Principle",
    image: "./images/P04-principle/Pr003-2.webp",
    prompt: "<span class='yf3'>到了退休才知道當年主管幹不久的原因~非提示詞",
    date: "2026-08-17",
    url: "",
  },
  {
    ...
    title: "毀謗老婆的後果-1",
    category: "Fun",
    image: "./images/F01-Fun/F011-1.webp",
    prompt:
      "請以我提供的兩張人物照片作為角色外貌參考，生成一張16:9橫向、四幕合一的高品質Q版故事資訊圖表。  畫面最上方置中放置完整標題，標題文字不可修改：  「🦷 牙痛男子求生實錄：財政部長與武則天的奇幻漂流」  人物設定：  男主角依第一張照片製作Q版造型，保留可辨識特徵：中年男性、短黑髮、黑色墨鏡、黑色外套、白色上衣，表情可愛但帶點無奈。  女主角依第二張照片製作Q版造型，保留可辨識特徵：中年女性、短棕色髮型、圓框眼鏡、溫和笑容、深綠色上衣、紅色斜背帶。她在故事中具有「財政部長兼武則天」般的霸氣幽默氣場。  兩人皆為Q版角色，人物比例自然可愛，表情生動，不要做成真人寫實風格。  整體視覺：  採用溫暖明亮、幽默逗趣的手繪漫畫式資訊圖表風格。以奶油米白、暖橘、淡粉、淺藍為主色，搭配鋼筆手繪線條、圓角分格、箭頭與小圖示。畫面清楚分為四個漫畫場景，以鋼筆手繪彎曲箭頭依序串連。所有文字一律使用繁體中文，字體必須是清楚、優雅、可閱讀的鋼筆手寫字體。畫面中不要出現英文，不要出現英文字母，不要錯字，不要亂碼，不要產生多餘人物。  第一幕放在左上角：  標題文字：「第一幕：牙痛不是病，痛起來瘦一斤」  畫男主角坐在家中沙發，臉頰微腫、手捂牙痛處，旁邊有藥丸、藥袋與痛感星芒圖示。再畫一個體重計，清楚顯示「瘦1公斤」。女主角在後方暗自竊喜，旁邊以小圖示呈現省下伙食費的幽默感。  小文字：「牙床罷工，痛到吃不下」「意外瘦了1公斤」  第二幕放在右上角：  標題文字：「第二幕：掛號也驚險，牙醫神吐槽」  畫面設在明亮乾淨的牙醫診所。男主角拿著手機、神情為難；Q版牙醫穿白袍與口罩，露出看穿一切的幽默表情。加入時鐘圖示，清楚指向3點半。  對話框必須清楚呈現：  牙醫：「明天下午3點好嗎？」  男主角：「晚一點比較好，要載太太下班，不然回家沒飯吃」  牙醫：「你這哪是財政部長，根本是武則天啊！」  小文字：「最終敲定3點半」  第三幕放在左下角：  標題文字：「第三幕：現世報來得太快，求老婆施法」  畫男主角把手機截圖傳給女主角，手機畫面可呈現「武則天」三字。女主角雙手抱胸、神情威嚴霸氣，周圍有小型法庭槌與閃電圖示。男主角隨即跪地雙手合十求饒，另一手仍捂住疼痛臉頰，表情可憐又滑稽。  對話框必須清楚呈現：  女主角：「告你毀謗，法庭見！」  男主角：「老大我錯了，你趕快施法讓我牙齒不痛！」  小文字：「牙痛突然加劇，深刻反省中」  第四幕放在右下角：  標題文字：「尾聲：牙痛會好，求生慾不能掉」  畫面中央使用天平資訊圖表。天平左側是一顆牙齒與牙醫小圖示，文字：「牙齒痛不痛，那是牙醫的事」。天平右側是女主角帶著滿意微笑的Q版頭像與一碗熱騰騰的飯，文字：「老婆心情好不好，攸關回家有沒有飯吃」。天平下方畫男主角微微鞠躬、雙手合十道歉，露出卑微但如釋重負的笑容。  畫面最底部加入一句收尾文字：  「牙痛會好，求生慾不能掉」  版面必須整潔、資訊層次分明、文字清楚可讀、人物五官一致、四幕角色造型保持一致。不要血腥畫面，不要恐怖醫療畫面，不要政治人物肖像，不要真實武則天造型；「武則天」僅作為女主角霸氣家庭地位的幽默比喻。    ",
    date: "2026-08-19",
    url: "",
  },
  {
    ...
    title: "毀謗老婆的後果-2",
    category: "Fun",
    image: "./images/F01-Fun/F011-2.webp",
    prompt:
      "請以我提供的兩張人物照片作為角色外貌參考，生成一張16:9橫向、四幕合一的高品質Q版故事資訊圖表。  畫面最上方置中放置完整標題，標題文字不可修改：  「🦷 牙痛男子求生實錄：財政部長與武則天的奇幻漂流」  人物設定：  男主角依第一張照片製作Q版造型，保留可辨識特徵：中年男性、短黑髮、黑色墨鏡、黑色外套、白色上衣，表情可愛但帶點無奈。  女主角依第二張照片製作Q版造型，保留可辨識特徵：中年女性、短棕色髮型、圓框眼鏡、溫和笑容、深綠色上衣、紅色斜背帶。她在故事中具有「財政部長兼武則天」般的霸氣幽默氣場。  兩人皆為Q版角色，人物比例自然可愛，表情生動，不要做成真人寫實風格。  整體視覺：  採用溫暖明亮、幽默逗趣的手繪漫畫式資訊圖表風格。以奶油米白、暖橘、淡粉、淺藍為主色，搭配鋼筆手繪線條、圓角分格、箭頭與小圖示。畫面清楚分為四個漫畫場景，以鋼筆手繪彎曲箭頭依序串連。所有文字一律使用繁體中文，字體必須是清楚、優雅、可閱讀的鋼筆手寫字體。畫面中不要出現英文，不要出現英文字母，不要錯字，不要亂碼，不要產生多餘人物。  第一幕放在左上角：  標題文字：「第一幕：牙痛不是病，痛起來瘦一斤」  畫男主角坐在家中沙發，臉頰微腫、手捂牙痛處，旁邊有藥丸、藥袋與痛感星芒圖示。再畫一個體重計，清楚顯示「瘦1公斤」。女主角在後方暗自竊喜，旁邊以小圖示呈現省下伙食費的幽默感。  小文字：「牙床罷工，痛到吃不下」「意外瘦了1公斤」  第二幕放在右上角：  標題文字：「第二幕：掛號也驚險，牙醫神吐槽」  畫面設在明亮乾淨的牙醫診所。男主角拿著手機、神情為難；Q版牙醫穿白袍與口罩，露出看穿一切的幽默表情。加入時鐘圖示，清楚指向3點半。  對話框必須清楚呈現：  牙醫：「明天下午3點好嗎？」  男主角：「晚一點比較好，要載太太下班，不然回家沒飯吃」  牙醫：「你這哪是財政部長，根本是武則天啊！」  小文字：「最終敲定3點半」  第三幕放在左下角：  標題文字：「第三幕：現世報來得太快，求老婆施法」  畫男主角把手機截圖傳給女主角，手機畫面可呈現「武則天」三字。女主角雙手抱胸、神情威嚴霸氣，周圍有小型法庭槌與閃電圖示。男主角隨即跪地雙手合十求饒，另一手仍捂住疼痛臉頰，表情可憐又滑稽。  對話框必須清楚呈現：  女主角：「告你毀謗，法庭見！」  男主角：「老大我錯了，你趕快施法讓我牙齒不痛！」  小文字：「牙痛突然加劇，深刻反省中」  第四幕放在右下角：  標題文字：「尾聲：牙痛會好，求生慾不能掉」  畫面中央使用天平資訊圖表。天平左側是一顆牙齒與牙醫小圖示，文字：「牙齒痛不痛，那是牙醫的事」。天平右側是女主角帶著滿意微笑的Q版頭像與一碗熱騰騰的飯，文字：「老婆心情好不好，攸關回家有沒有飯吃」。天平下方畫男主角微微鞠躬、雙手合十道歉，露出卑微但如釋重負的笑容。  畫面最底部加入一句收尾文字：  「牙痛會好，求生慾不能掉」  版面必須整潔、資訊層次分明、文字清楚可讀、人物五官一致、四幕角色造型保持一致。不要血腥畫面，不要恐怖醫療畫面，不要政治人物肖像，不要真實武則天造型；「武則天」僅作為女主角霸氣家庭地位的幽默比喻。    ",
    date: "2026-08-19",
    url: "",
  ...
  {
    id: 415,
    title: "文專員的『閃電退休』三秒鐘」-1",
    category: "Fun",
    image: "./images/F01-Fun/F011-3.webp",
    prompt:
      "製作一張十六比九橫式資訊圖表，主題標題必須完整保留為「文專員的『閃電退休』三秒鐘」，標題置於畫面最上方中央，使用醒目的手寫鋼筆字體。以附件人物圖片中的角色作為主角，呈現可愛、略帶疲憊但堅毅表情的四頭身Q版人物，角色穿著銀行員制服（白襯衫、深色背心或套裝），站在畫面中央偏左位置，一手拿著印章、一手按著太陽穴，表情呈現「內心崩潰但身體自動蓋章」的無奈感。整體採用「內心幻想 vs 現實對比」的雙場景設計：畫面以一道波浪線或閃電分割線分成左右兩側。  左側區塊（幻想世界）：用夢幻粉紫色背景，主角Q版人物呈現帥氣姿態——雙手叉腰、一腳踩在椅子上，另一手高舉退休申請書，申請書在空中劃出完美弧線飛向課長（課長以Q版小人身影呈現，被紙張砸中鼻尖、表情驚呆）。周圍散落二十多件文件隨風飄飛，主角腳邊有抱枕與股票K線圖的小圖示，文字標示「內心小劇場：老娘不幹了！我要回家打老公、炒股票！」字體誇張帶戲劇感。  右側區塊（現實世界）：用辦公室灰白色背景，主角Q版人物乖乖坐在辦公桌前，低頭專注蓋章，桌上堆疊四件標註「分行業務」的文件，旁邊同事也低頭蓋章，課長抱著文件走遠的背影。文字標示「現實：深呼吸，把退休申請書鎖回腦海，繼續蓋章。」字體平靜務實。  畫面最下方設計結論橫幅，文字完整呈現：「——獻給每一位在『剩下你們三個人』中默默蓋章的無名英雄。」字體溫暖帶致敬感。畫面風格明亮清晰、具有職場共鳴與幽默感，使用粉紫色表現幻想世界、灰白色表現現實世界，形成強烈對比。所有文字皆使用繁體中文，字體以鋼筆手寫風格為主，禁止出現任何英文、英文字母、拉丁字母、亂碼、錯別字與多餘文字，資訊層級清楚、文字準確、排版整齊、適合手機與社群平台閱讀，避免恐怖、血腥或令人不適的畫面。主角Q版人物表情生動，能傳達「職場社畜內心崩潰但身體自動運轉」的無奈與幽默，整體構圖平衡、視覺焦點明確。    ",
    date: "2026-08-19",
    url: "",
  },
  {
    id: 416,
    title: "文專員的『閃電退休』三秒鐘」-2",
    category: "Fun",
    image: "./images/F01-Fun/F011-4.webp",
    prompt:
      "製作一張十六比九橫式資訊圖表，主題標題必須完整保留為「文專員的『閃電退休』三秒鐘」，標題置於畫面最上方中央，使用醒目的手寫鋼筆字體。以附件1人物圖片中的角色作為主角，呈現可愛、略帶疲憊但堅毅表情的四頭身Q版人物，角色穿著銀行員制服（白襯衫、深色背心或套裝），站在畫面中央偏左位置，一手拿著印章、一手按著太陽穴，表情呈現「內心崩潰但身體自動蓋章」的無奈感。整體採用「內心幻想 vs 現實對比」的雙場景設計：畫面以一道波浪線或閃電分割線分成左右兩側。    左側區塊（幻想世界）：用夢幻粉紫色背景，主角Q版人物呈現帥氣姿態——雙手叉腰、一腳踩在椅子上，另一手高舉退休申請書，申請書在空中劃出完美弧線飛向課長（課長以Q版小人身影呈現，被紙張砸中鼻尖、表情驚呆）。周圍散落二十多件文件隨風飄飛，主角腳邊有抱枕與股票K線圖的小圖示，文字標示「內心小劇場：老娘不幹了！我要回家打老公(附件2圖片人物Q版墨鏡造型)、炒股票！」字體誇張帶戲劇感。    右側區塊（現實世界）：用辦公室灰白色背景，(附件1)主角Q版人物乖乖坐在辦公桌前，低頭專注蓋章，桌上堆疊四件標註「分行業務」的文件，旁邊同事也低頭蓋章，課長抱著文件走遠的背影。文字標示「現實：深呼吸，把退休申請書鎖回腦海，繼續蓋章。」字體平靜務實。    畫面最下方設計結論橫幅，文字完整呈現：「——獻給每一位在『剩下你們三個人』中默默蓋章的無名英雄。」字體溫暖帶致敬感。畫面風格明亮清晰、具有職場共鳴與幽默感，使用粉紫色表現幻想世界、灰白色表現現實世界，形成強烈對比。所有文字皆使用繁體中文，字體以鋼筆手寫風格為主，禁止出現任何英文、英文字母、拉丁字母、亂碼、錯別字與多餘文字，資訊層級清楚、文字準確、排版整齊、適合手機與社群平台閱讀，避免恐怖、血腥或令人不適的畫面。主角Q版人物表情生動，能傳達「職場社畜內心崩潰但身體自動運轉」的無奈與幽默，整體構圖平衡、視覺焦點明確。  ",
    date: "2026-08-19",
    url: "",
  },
  {
    ...
    title: "深藍選民的移動困境",
    category: "Fun",
    image: "./images/F01-Fun/F011-5.webp",
    prompt:
      "製作一張十六比九橫式資訊圖表，主題標題必須完整保留為「深藍選民的移動困境：2026 新北市長選舉後的交通選擇」，標題置於畫面最上方中央，使用醒目的手寫鋼筆字體。以附件人物圖片中的角色作為主角，呈現可愛、略帶困擾與思考表情的四頭身Q版人物，角色站在畫面中央偏左位置，一手拿著地圖、一手托腮，表情呈現「想出門但被包圍」的為難感。整體採用「中心人物＋放射狀路線圖」設計：中央為主角Q版人物，從人物向外延伸三條主要路徑，分別用不同顏色與圖示標示。  左上區塊標示「陸路交通：不可行」，用紅色叉號標記，搭配高速公路、台鐵、高鐵被新北市包圍的示意圖，文字為「台北市被新北市完全包圍，所有陸路必經新北市」。  右上區塊標示「航空選項一：外島」，用綠色勾號標記，搭配飛機、金門、馬祖、澎湖的島嶼圖示與國民黨旗幟，文字為「松山機場飛往金門、馬祖、澎湖（外島藍營執政）」。  下方區塊標示「航空選項二：台東」，用黃色警示標記，搭配飛機、台東地標（熱氣球）、國民黨旗幟，並用小字註記「飛機航經新北上空」，文字為「松山機場飛往台東（本島唯一藍營縣市，但航線經過新北）」。  畫面最下方設計醒目的結論橫幅，文字完整呈現：「地理現實：台北市居民若要前往本島大部分地區，必然經過新北市。」畫面風格明亮清晰、具有教育性與資訊圖表感，使用紅色表現不可行選項、綠色表現可行選項、黃色表現需注意選項，所有文字皆使用繁體中文，字體以鋼筆手寫風格為主，禁止出現任何英文、英文字母、拉丁字母、亂碼、錯別字與多餘文字，資訊層級清楚、文字準確、排版整齊、適合手機與社群平台閱讀，避免恐怖、血腥或令人不適的畫面。主角Q版人物表情生動，能傳達「被地理現實困住」的無奈感，整體構圖平衡、視覺焦點明確。    ",
    date: "2026-08-19",
    url: "",
  },
  {
    ...
    title: "悠閒坐在沙發~迷你分身-1",
    category: "Mini",
    image: "./images/M02-Mini/M006-1.webp",
    prompt:
      "忠實重現主角人物，禁止變更為他人。將同一人物製作為「通常尺寸＋超迷你尺寸」的六人，並進行 2.5〜3 頭身的超高品質 3D 角色化。  通常尺寸的人物面帶微笑，使用一隻手的拇指和食指，溫柔地捏住迷你尺寸自己的「衣領（脖子處的衣服）」並提起。手指不得直接捏住脖子或身體，必須且僅能捏住衣領、脖子處的衣服部分。迷你角色懸在空中，雙手雙腳揮動，露出困擾但可愛的表情。大尺寸的自己注視著迷你尺寸的自己，開心地笑著。其他四個分身都在主角身上  兩人的臉部、髮型、服裝必須統一，以便辨識為同一人。壓倒性的尺寸差、強烈的透視感、柔和的光線、電影品質 3DCG、可愛且幽默、超高精細。手指為自然的 5 根手指。橫向 16:9。  ",
    date: "2026-08-19",
    url: "",
  },
  {
    ...
    title: "牙疼看醫生-2",
    category: "Mini",
    image: "./images/M02-Mini/M006-2.webp",
    prompt:
      "一名中年亞洲男性(如附件)因為嚴重牙疼，坐在明亮整潔的現代牙科診所治療椅上。他身穿黑色休閒外套與白色上衣，戴著黑框眼鏡，表情痛苦又無奈，一手捂著臉頰，另一手緊抓著治療椅扶手，嘴巴微微張開，露出正在接受檢查的牙齒。牙醫站在他面前，穿著白色醫師袍、戴著口罩與手套，手持牙科口鏡與探針，正專注地檢查他的牙齒；旁邊可見牙科治療燈、器械托盤、吸唾管與現代化牙科設備。  延續參考圖的超現實比例效果：在這名巨大人物的身邊、肩膀、手臂、膝蓋、牙科椅扶手與診療設備周圍，安排十個穿著同樣附件的人物小人。他們每一個都有不同的姿勢、動作與表情，形成熱鬧而有戲劇性的群像：  一個小人站在患者肩膀上，捂著嘴巴大笑，表情明顯嘲笑患者牙疼。  一個小人坐在牙科椅扶手上，露出同情與擔心的表情，雙手合十安慰患者。  一個小人拿著小型牙刷，認真示範正確刷牙方式。  一個小人抱著臉頰，模仿患者牙疼的痛苦表情。  一個小人摀住耳朵，因為患者的呻吟而露出害怕又誇張的表情。  一個小人拿著冰袋，準備替患者冰敷臉頰，表現出關懷。  一個小人站在器械托盤旁，緊張地看著牙醫手中的器械。  一個小人拿著帳單，露出震驚、心痛又欲哭無淚的表情。  一個小人雙手叉腰，像嚴格的衛生老師一樣責備患者平常沒有好好刷牙。  一個小人站在牙科治療燈旁，對著患者揮手加油，臉上露出鼓勵與樂觀的笑容。  十個迷你人物的表情要明顯區分，包括嘲笑、同情、驚恐、緊張、責備、驚訝、鼓勵、幸災樂禍、關懷與無奈。整體畫面要兼具幽默感與戲劇性，但不要恐怖或血腥；牙齒與牙科器械呈現自然、乾淨、專業的效果。使用溫暖診所燈光、細膩皮膚質感、真實布料紋理、自然景深、高細節攝影風格、電影級構圖、柔和背景虛化、寫實人物比例與迷你人物的超現實比例對比。畫面充滿故事性，讓觀眾一眼就能感受到「牙疼時身邊出現各種反應的小人」這個幽默概念。  圖型比例為16:9    ",
    date: "2026-08-19",
    url: "",
  },
  {
  ...
  },
  {
    ...
    title: "人生的一百年~個人-1",
    category: "Portrait",
    image: "./images/P02-Portrait/P009-1.webp",
    prompt:
      "<span class='yf3'>人生的一百年：從稚嫩到睿智，每一段歲月都值得被溫柔以待。~</span>Use the uploaded image as the primary facial identity reference. Create an extraordinary visual timeline showing the SAME PERSON across an entire 100-year lifespan. Show approximately 10 stages: Age 5 → 15 → 25 → 35 → 45 → 55 → 65 → 75 → 85 → 95. Preserve recognizable facial identity while naturally progressing through age. Show realistic changes in facial structure, skin texture, hair, wrinkles, posture and expression. ",
    date: "2026-08-22",
    url: "",
  },
  {
    ...
    title: "人生的一百年~個人-2",
    category: "Portrait",
    image: "./images/P02-Portrait/P009-2.webp",
    prompt:
      "<span class='yf3'>人生的一百年：從稚嫩到睿智，每一段歲月都值得被溫柔以待。~</span>提示詞同422",
    date: "2026-08-22",
    url: "",
  },
  {
    ...
    title: "人生的一百年~個人-3",
    category: "Portrait",
    image: "./images/P02-Portrait/P009-3.webp",
    prompt:
      "<span class='yf3'>人生的一百年：從稚嫩到睿智，每一段歲月都值得被溫柔以待。~</span>提示詞同422",
    date: "2026-08-22",
    url: "",
  },
  {
    ...
    title: "人生的一百年~老婆-1",
    category: "Portrait",
    image: "./images/P02-Portrait/P009-4.webp",
    prompt:
      "<span class='yf3'>人生的一百年：從稚嫩到睿智，每一段歲月都值得被溫柔以待。~</span>提示詞同422",
    date: "2026-08-22",
    url: "",
  },
  {
    ...
    title: "人生的一百年~老婆-2",
    category: "Portrait",
    image: "./images/P02-Portrait/P009-5.webp",
    prompt:
      "<span class='yf3'>人生的一百年：從稚嫩到睿智，每一段歲月都值得被溫柔以待。~</span>提示詞同422",
    date: "2026-08-22",
    url: "",
  },
  {
    ...
    title: "人生的一百年~老婆-3",
    category: "Portrait",
    image: "./images/P02-Portrait/P009-5A.webp",
    prompt:
      "<span class='yf3'>人生的一百年：從稚嫩到睿智，每一段歲月都值得被溫柔以待。~</span>提示詞同422",
    date: "2026-08-22",
    url: "",
  },
  {
    ...
    title: "人生的一百年~詣超-1",
    category: "Portrait",
    image: "./images/P02-Portrait/P009-6.webp",
    prompt:
      "<span class='yf3'>人生的一百年：從稚嫩到睿智，每一段歲月都值得被溫柔以待。~</span>提示詞同422",
    date: "2026-08-22",
    url: "",
  },
  {
    ...
    title: "人生的一百年~小胖-1",
    category: "Portrait",
    image: "./images/P02-Portrait/P009-7.webp",
    prompt:
      "<span class='yf3'>人生的一百年：從稚嫩到睿智，每一段歲月都值得被溫柔以待。~</span>提示詞同422",
    date: "2026-08-22",
    url: "",
  },
  {
    ...
    title: "人生的一百年~川哥-1",
    category: "Portrait",
    image: "./images/P02-Portrait/P009-8.webp",
    prompt:
      "<span class='yf3'>人生的一百年：從稚嫩到睿智，每一段歲月都值得被溫柔以待。~</span>提示詞同422",
    date: "2026-08-22",
    url: "",
  },
  {
    ...
    title: "月餅採購生死門-1",
    category: "Festival",
    image: "./images/F02-Festival/F003-1.webp",
    prompt:
      "附件一Q版墨鏡造型~主角、附件二Q版造型老婆      製作一張 16:9 橫式、單一畫面的繁體中文幽默故事型資訊圖表，主題是「月餅采購生死鬥」。採用四格漫畫式敘事資訊圖表，將故事由左至右、由上至下清楚呈現，畫面分成三個主要情節區塊，並以箭頭和情緒溫度計串聯，呈現老婆提醒語氣逐步升級的喜劇張力。      最上方放置主標題，文字必須完全保持為：   「中秋將至，我家最近上演的戲碼不是烤肉，是「月餅采購生死鬥」。」      畫面主角設定為一名退休老師，約六十多歲、戴眼鏡、穿著樸素居家的長袖上衣，表情從悠閒、疑惑逐漸轉為緊張崩潰；配角為他的老婆，神情從溫柔提醒逐步變成嚴肅警告。場景設定在溫馨但充滿壓力的家中餐桌，桌上可放置月餅禮盒、訂購單、手機與中秋節裝飾，營造家庭喜劇氛圍。      第一區塊呈現第一次提醒，老婆面帶微笑、語氣溫柔，對退休老師說：   「親愛的，阿默的月餅訂了沒？晚了就沒了。」   搭配低溫、柔和色彩與小型月亮圖示。      第二區塊呈現第二次提醒，老婆眉頭微皺、雙手叉腰，退休老師開始緊張查看手機，對話文字為：   「你到底訂了沒？別人都訂好了。」   搭配升溫中的情緒溫度計、逐漸變大的提醒符號，以及較鮮明的橘紅色。      第三區塊呈現第三次最後通牒，老婆氣勢強烈、手指指向月餅訂購單，退休老師露出震撼、投降般的表情，對話文字必須為：   「你要是這次又忘記，中秋節你就自己一個人過。」   此區塊以高張力紅色警示效果、放大的驚嘆號、倒數計時圖示與孤單月亮呈現，但整體維持誇張幽默，不要恐怖或暴力。      畫面右下角加入故事結論式視覺文字：   「退休老師：什麼場面都見過，卻敗在自家餐桌前。」   並以小型資訊標籤呈現：   「威脅利誘的極致藝術」   「不威脅身體，直接威脅中秋節」      所有文字皆使用繁體中文，字體以清楚易讀的鋼筆手寫字體為主，標題最大且位於最上方，對話框與重點標籤層級分明。畫面中不要出現任何不必要的英文，專業英文縮寫例外。整體風格為高品質社群分享型資訊圖表，溫馨家庭喜劇、角色表情生動、構圖清晰、色彩具有情緒遞進效果，避免文字錯漏、避免簡體中文、避免多餘人物、避免血腥、避免恐怖元素。  ",
    date: "2026-08-22",
    url: "",
  },
  {
    ...
    title: "月餅採購生死門-2",
    category: "Festival",
    image: "./images/F02-Festival/F003-2.webp",
    prompt: "提示詞同431",
    date: "2026-08-22",
    url: "",
  },
  {
    ...
    title: "牙疼看醫生-3",
    category: "Mini",
    image: "./images/M02-Mini/M006-3.webp",
    prompt: "提示詞同419",
    date: "2026-08-22",
    url: "",
  },
  {
    ...
    title: "家中公仔飛起來-1",
    category: "Life",
    image: "./images/L02-Life/L022-1.webp",
    prompt:
      "畫面中十二個玩偶分別站立在星巴克隨行杯杯蓋上一字排開。讓每個公仔以輕盈、可愛的彈跳節奏微微向上飄起、懸浮一瞬，帶著開心搖擺的表情與肢體動作，像是慶祝般輕輕跳動、頭部左右晃動，展現童趣活潑的情緒。同一時間，公仔下方的星巴克杯子也緩緩浮起離開桌面幾公分，並以杯身為中心軸做一次平順的 360 度自轉；在轉動的過程中，杯身正面的星巴克標誌圖案逐漸溶解、模糊，轉換成對應的文字（例如品牌名稱或杯型文字），接著文字再繼續隨杯子轉動變回原本的圖案標誌，形成圖案與文字互相轉換的視覺魔術效果。整體動態需保持柔和、有彈性的物理感，光線維持原本溫暖的室內燈光與桌面反光，背景（電腦螢幕、鍵盤）維持靜止不動，只有公仔與杯子產生浮動與旋轉的真實場景，節奏輕快、循環流暢，呈現療癒且療愉悅的氛圍。 ",
    date: "2026-08-22",
    url: "",
  },
  {
    ...
    title: "家中公仔飛起來-2",
    category: "Life",
    image: "./images/L02-Life/L022-2.webp",
    prompt:
      "畫面中十二個玩偶分別站立在星巴克隨行杯杯蓋上一字排開。讓每個公仔以輕盈、可愛的彈跳節奏微微向上飄起、懸浮一瞬，帶著開心搖擺的表情與肢體動作，像是慶祝般輕輕跳動、頭部左右晃動，展現童趣活潑的情緒。同一時間，公仔下方的星巴克杯子也緩緩浮起離開桌面幾公分，並以杯身為中心軸做一次平順的 360 度自轉；在轉動的過程中，杯身正面的星巴克標誌圖案逐漸溶解、模糊，轉換成對應的文字（例如品牌名稱或杯型文字），接著文字再繼續隨杯子轉動變回原本的圖案標誌，形成圖案與文字互相轉換的視覺魔術效果。整體動態需保持柔和、有彈性的物理感，光線維持原本溫暖的室內燈光與桌面反光，背景（電腦螢幕、鍵盤）維持靜止不動，只有公仔與杯子產生浮動與旋轉的真實場景，節奏輕快、循環流暢，呈現療癒且療愉悅的氛圍。 ",
    date: "2026-08-22",
    url: "",
  },
  {
    ...
    title: "家中公仔飛起來(影片)-1",
    category: "Life",
    image: "./images/L02-Life/L023-1.mp4",
    prompt:
      "畫面中十二個迪士尼 Tsum Tsum 公仔（歪嘴雞、大眼仔、愛麗兒、史迪奇、奇奇蒂蒂、三眼怪、唐老鴨、小飛象、杯麵、蒂蒂、瑞比兔、瑪莉貓）分別站立在星巴克隨行杯杯蓋上一字排開。讓每個公仔以輕盈、可愛的彈跳節奏微微向上飄起、懸浮一瞬，帶著開心搖擺的表情與肢體動作，像是慶祝般輕輕跳動、頭部左右晃動，展現童趣活潑的情緒。同一時間，公仔下方的星巴克杯子也緩緩浮起離開桌面幾公分，並以杯身為中心軸做一次平順的 360 度自轉；在轉動的過程中，杯身正面的星巴克標誌圖案逐漸溶解、模糊，轉換成對應的文字（例如品牌名稱或杯型文字），接著文字再繼續隨杯子轉動變回原本的圖案標誌，形成圖案與文字互相轉換的視覺魔術效果。整體動態需保持柔和、有彈性的物理感，光線維持原本溫暖的室內燈光與桌面反光，背景（電腦螢幕、鍵盤）維持靜止不動，只有公仔與杯子產生浮動與旋轉的動畫，節奏輕快、循環流暢，呈現療癒且療愉悅的氛圍。 ",
    date: "2026-08-22",
    url: "",
  },
  {
    ...
    title: "家中公仔飛起來(影片)-2",
    category: "Life",
    image: "./images/L02-Life/L023-2.mp4",
    prompt:
      "請以原始照片中的所有公仔為主體，製作一張高度寫實、自然可信的照片。讓所有公仔看起來像是在同一瞬間因輕微氣流或彈跳而稍微離開底座，向上浮起約幾公分，呈現開心、活潑、充滿喜悅的狀態。每個公仔保持原本的外型、材質、顏色、比例與細節，不要改變角色特徵；可以透過自然的姿勢、微微張開的手臂、輕鬆的身體角度，以及柔和明亮的光線，表現愉快情緒。畫面必須像真實相機拍攝的瞬間，保留原始桌面、電腦螢幕、鍵盤、背景環境、景深、陰影與玻璃桌面的自然反射。公仔下方保留細緻、合理的懸浮陰影，讓浮起的效果符合真實光線與物理空間。背景保持穩定，構圖與拍攝角度維持不變，整體呈現自然、溫暖、清晰、高細節的寫實攝影效果。 ",
    date: "2026-08-22",
    url: "",
  },
  {
    ...
    title: "家中公仔飛起來(影片)-3",
    category: "Life",
    image: "./images/L02-Life/L023-3.mp4",
    prompt:
      "請以原始照片中的所有公仔為主體，製作一張高度寫實、自然可信的照片。讓所有公仔看起來像是在同一瞬間因輕微氣流或彈跳而稍微離開底座，向上浮起約幾公分，呈現開心、活潑、充滿喜悅的狀態。每個公仔保持原本的外型、材質、顏色、比例與細節，不要改變角色特徵；可以透過自然的姿勢、微微張開的手臂、輕鬆的身體角度，以及柔和明亮的光線，表現愉快情緒。畫面必須像真實相機拍攝的瞬間，保留原始桌面、電腦螢幕、鍵盤、背景環境、景深、陰影與玻璃桌面的自然反射。公仔下方保留細緻、合理的懸浮陰影，讓浮起的效果符合真實光線與物理空間。背景保持穩定，構圖與拍攝角度維持不變，整體呈現自然、溫暖、清晰、高細節的寫實攝影效果。 ",
    date: "2026-08-22",
    url: "",
  ...
  {
    id: 439,
    title: "詣超半夜和同事聚會晚回家-1",
    category: "Life",
    image: "./images/L02-Life/L023-1.webp",
    prompt:
      "<span class='yf3'>利用Perplexity空間~P001-產生文章的資訊圖表提示詞產出後到Arena網站生圖~內容</span>~我家有位健身教練兒子，平時晚上十一點下班，十二點左右就會準時出現在家門口。而家裡還有一位比鬧鐘還準時的「認真魔人」爸爸，每天凌晨三點多就會自動開機起床。 某天凌晨三點，爸爸醒來發現玄關依然安靜如雞，兒子竟然還沒回來！他趕緊查看Line，發現兒子在半夜十一點半曾留下一條訊息：「我一樣去吃個東西喔，冷氣可以先關。」 結果這一「吃」，就吃到凌晨三點多還在外面飄？爸爸忍不住回訊吐槽：「你該不會是跑去高雄吃東西吧？」（畢竟從家裡吃到高雄，才配得上這個時長啊！） 兒子秒回：「吃熱炒啦、還在聊天、組長請客～」 爸爸雖然心裡OS「組長的錢包是無底洞嗎」，但還是展現了父親的關懷（兼碎念）：「晚上外面問題比較多，早點回來啊！」 然而，時間悄悄滑到了清晨五點多……兒子依然沒進門。 此時爸爸的擔心已經升級成一種哲學式的困惑，他再次拿起手機，對著兒子發出了靈魂拷問： 「兒子啊，你們那間熱炒店，是已經原地轉型變成早餐店了嗎？」 ",
    date: "2026-08-30",
    url: "",
  },
  {
    id: 440,
    title: "詣超半夜和同事聚會晚回家-2",
    category: "Life",
    image: "./images/L02-Life/L023-2.webp",
    prompt: "同439",
    date: "2026-08-30",
    url: "",
  },
  {
    id: 441,
    title: "詣超半夜和同事聚會晚回家-3",
    category: "Life",
    image: "./images/L02-Life/L023-3.webp",
    prompt: "同439",
    date: "2026-08-30",
    url: "",
  },
  {
    id: 442,
    title: "詣超半夜和同事聚會晚回家-4",
    category: "Life",
    image: "./images/L02-Life/L023-4.webp",
    prompt: "同439",
    date: "2026-08-30",
    url: "",
  },
  {
    id: 443,
    title: "一場聚餐三人參與二人掛病號-1",
    category: "Fun",
    image: "./images/F01-Fun/F012-1.webp",
    prompt:
      "生成一張 16:9 橫式懸疑偵探新聞風資訊圖表，主標題置於最上方並完全使用：「三人聚餐、兩人掛病號」；所有文字皆為繁體中文，以優雅手寫鋼筆字體呈現。畫面中心是一張溫馨卻帶神祕氣氛的圓形餐桌，三位約六十歲、神情熟悉親切的臺灣老同學正在生日聚餐，桌上有蛋糕、家常料理、飲料與生日小蠟燭。採用「案件調查板」資訊圖表構圖：左側是「認識超過四十年」「壽星熱情邀約」「談青春與退休生活」三張泛黃回憶照片卡；中央以醒目時間軸呈現「生日聚餐」箭頭指向「一天後」；右側設計兩份幽默病況檔案，一位同學捧著腰部、旁邊標示「結石來報到」，另一位同學戴口罩打噴嚏、旁邊標示「感冒悄悄上身」。用紅色細繩、圖釘、放大鏡、問號、指紋和微微發光的飲料杯，連結所有事件線索；下方設置「疑點追查」區塊，寫著「年紀到了？」、「友情結石配方？」、「健康壓力測試套餐？」；右下角加上一張幽默的健康風險告知書，文字為「下次邀約前，先問：單純吃飯嗎？」整體色調採深藍、酒紅、暖黃與牛皮紙褐色，兼具老同學情誼、溫暖回憶與誇張懸疑感；人物表情生動逗趣，版面清楚、文字正確易讀、細節精緻，無任何英文文字。注意選項，所有文字皆使用繁體中文，字體以鋼筆手寫風格為主，禁止出現任何英文、英文字母、拉丁字母、亂碼、錯別字與多餘文字，資訊層級清楚、文字準確、排版整齊、適合手機與社群平台閱讀，避免恐怖、血腥或令人不適的畫面。主角Q版人物表情生動，能傳達「被地理現實困住」的無奈感，整體構圖平衡、視覺焦點明確。    ",
    date: "2026-08-30",
    url: "",
  },
  {
    id: 444,
    title: "一場聚餐三人參與二人掛病號-2",
    category: "Fun",
    image: "./images/F01-Fun/F012-2.webp",
    prompt:
      "生成一張 16:9 橫式懸疑偵探新聞風資訊圖表，主標題置於最上方並完全使用：「三人聚餐、兩人掛病號」；所有文字皆為繁體中文，以優雅手寫鋼筆字體呈現。畫面中心是一張溫馨卻帶神祕氣氛的圓形餐桌，三位約六十歲、神情熟悉親切的臺灣老同學正在生日聚餐，桌上有蛋糕、家常料理、飲料與生日小蠟燭。採用「案件調查板」資訊圖表構圖：左側是「認識超過四十年」「壽星熱情邀約」「談青春與退休生活」三張泛黃回憶照片卡；中央以醒目時間軸呈現「生日聚餐」箭頭指向「一天後」；右側設計兩份幽默病況檔案，一位同學捧著腰部、旁邊標示「結石來報到」，另一位同學戴口罩打噴嚏、旁邊標示「感冒悄悄上身」。用紅色細繩、圖釘、放大鏡、問號、指紋和微微發光的飲料杯，連結所有事件線索；下方設置「疑點追查」區塊，寫著「年紀到了？」、「友情結石配方？」、「健康壓力測試套餐？」；右下角加上一張幽默的健康風險告知書，文字為「下次邀約前，先問：單純吃飯嗎？」整體色調採深藍、酒紅、暖黃與牛皮紙褐色，兼具老同學情誼、溫暖回憶與誇張懸疑感；人物表情生動逗趣，版面清楚、文字正確易讀、細節精緻，無任何英文文字。注意選項，所有文字皆使用繁體中文，字體以鋼筆手寫風格為主，禁止出現任何英文、英文字母、拉丁字母、亂碼、錯別字與多餘文字，資訊層級清楚、文字準確、排版整齊、適合手機與社群平台閱讀，避免恐怖、血腥或令人不適的畫面。主角Q版人物表情生動，能傳達「被地理現實困住」的無奈感，整體構圖平衡、視覺焦點明確。    ",
    date: "2026-08-30",
    url: "",
  ...
  {
    id: 445,
    title: "詣超半夜和同事聚會晚回家-part2-1",
    category: "Life",
    image: "./images/L02-Life/L023-5.webp",
    prompt:
      "<span class='yf3'>利用Perplexity空間~P001-產生文章的資訊圖表提示詞產出後到Arena網站生圖~內容</span>~【兒子下班晚回家 Part 2：永和豆漿之亂與爸爸的請客攻勢】  時間來到清晨六點多，那位比雞還早起的認真爸爸，終於等到了兒子的Line回覆。  本以為上集那句「熱炒變早餐店」只是老爸的幽默吐槽，沒想到兒子竟然誠實得令人髮指：「真的跑去吃永和豆漿了。」  爸爸看到訊息，差點沒從椅子上滑下來，忍不住自嘲兼驚嘆：「我亂說還真的命中啊？！」（看來爸爸的嘴根本是開過光的預言家。）  既然兒子都在吃豆漿了，爸爸立刻切換到「揪團模式」，熱情喊道：「內湖來來豆漿对吧？我跟你媽也要去！順便叫組長繼續請客啊！」（組長OS：我的錢包到底做錯了什麼……）  結果兒子只冷冷地回了一個字：「不要。」  這記冷漠的拒絕，堪稱清晨六點最冰冷的回應。但爸爸豈是這麼容易放棄的人？他立刻祭出終極殺手鐧——搬出媽媽大神！  「不然你媽說了，她請全部教練吃早餐喔！」  這句話一出，簡直是核彈級別的誘惑。不知道兒子有沒有心動，但爸爸顯然覺得自己這招很漂亮。  最後，爸爸不忘以一句溫暖（但略帶唸叨）的提醒作為這場清晨對話的完美句點：「沒事早點回家啦，一晚沒睡白天會很累的～」  至此，這場從凌晨三點延續到早上六點的「兒子去哪了＋早餐談判＋溫馨提醒」三合一連續劇，終於在爸爸的碎念中迎來了中場休息。   ",
    date: "2026-08-30",
    url: "",
  },
  {
    id: 446,
    title: "詣超半夜和同事聚會晚回家-part2-2",
    category: "Life",
    image: "./images/L02-Life/L023-6.webp",
    prompt: "同445",
    date: "2026-08-30",
    url: "",
  },
  {
    id: 447,
    title: "詣超半夜和同事聚會晚回家-part2-3",
    category: "Life",
    image: "./images/L02-Life/L023-7.webp",
    prompt: "同445",
    date: "2026-08-30",
    url: "",
  },
  {
    ...
    title: "群組中跟學生請求照片~1",
    category: "Life",
    image: "./images/L02-Life/L024-3.webp",
    prompt:
      "<span class='yf3'>利用Perplexity空間~P001-產生文章的資訊圖表提示詞產出後到Arena網站生圖~內容</span>~各位同學大家午安!老師有一事相求，就是我的畢業紀念冊放在石牌，我想找四個老師的照片，孟憲瑾、王義傑，林柏超、鄭佩輪，四個人的照片，幫我用手機拍清楚一點傳給我，感謝各位同學",
    date: "2026-09-03",
    url: "",
  },
  {
    id: 449,
    title: "群組中跟學生請求照片~2(失望篇)",
    category: "Life",
    image: "./images/L02-Life/L024-4.webp",
    prompt:
      "<span class='yf3'>利用Perplexity空間~P001-產生文章的資訊圖表提示詞產出後到Arena網站生圖~內容</span>~老師將上述詢息轉成圖片後，發送到LINE群組，老師一個人坐在電腦前，看著螢幕，靜靜的、默默的、痴痴的等待，看者電腦螢幕上的line視窗，等待、期待、渴望，希望有學生可以幫我這個忙，但是感覺他的希望是越來越渺茫!",
    date: "2026-09-03",
    url: "",
  },
  {
    id: 450,
    title: "群組中跟學生請求照片~3(失望篇)",
    category: "Life",
    image: "./images/L02-Life/L024-5.webp",
    prompt:
      "<span class='yf3'>利用Perplexity空間~P001-產生文章的資訊圖表提示詞產出後到Arena網站生圖~內容</span>~老師將上述詢息轉成圖片後，發送到LINE群組，老師一個人坐在電腦前，看著螢幕，靜靜的、默默的、痴痴的等待，看者電腦螢幕上的line視窗，等待、期待、渴望，希望有學生可以幫我這個忙，但是感覺他的希望是越來越渺茫!",
    date: "2026-09-03",
    url: "",
  ...
  {
    id: 451,
    title: "AI~懷念過去方城之戰~老孟文筆",
    category: "Life",
    image: "./images/L02-Life/L024-1.webp",
    prompt:
      "<span class='yf3'>時局一直在變，我們的興緻不變，當規則越來越複雜，見人臉越來越虛偽，所幸還有這方寸之境，容得下我們摘去面具，像個孩子一樣，只聊過去，不問明天",
    date: "2026-09-03",
    url: "https://www.facebook.com/share/p/1Hm5hWS94m/",
  },
  {
    id: 452,
    title: "AI~懷念過去方城之戰(復古版)~老孟文筆",
    category: "Life",
    image: "./images/L02-Life/L024-2.webp",
    prompt:
      "<span class='yf3'>時局一直在變，我們的興緻不變，當規則越來越複雜，見人臉越來越虛偽，所幸還有這方寸之境，容得下我們摘去面具，像個孩子一樣，只聊過去，不問明天",
    date: "2026-09-03",
    url: "",
  },
  {
    ...
    title: "回想過去方城之戰-1",
    category: "Principle",
    image: "./images/P04-principle/Pr004-1.webp",
    prompt:
      "<span class='yf3'>利用Perplexity空間~P001-產生文章的資訊圖表提示詞產出後到Arena網站生圖(3D動漫版~明亮色系)~內容</span>是朋友就先答應：麻將桌外的同事友誼~~退休超過三年，牌桌上的位置彷彿還留著我的名字。想起剛退休時，總會接到一通電話，開口便是「是朋友就先答應！」，就知道週六的方城之戰又要開打。輸贏其實是一回事，那份同事間的情誼才是最珍貴的收穫。如今退休三年多，距離上次聚會已有一段時間，聯絡漸少，大家也都各自忙碌。其實真正想念的不只是麻將，而是那句「是朋友就先答應！」的聲音。老實說最近身體狀況多多，或許無法再像從前那樣久坐打牌了。在輸贏之外，或許該主動傳個訊息問候：畢竟人生這副牌，能一起坐上桌的老朋友已經不多了，這份情誼比任何牌局都值得珍惜。",
    date: "2026-09-03",
    url: "",
  },
  {
    ...
    title: "回想過去方城之戰-2",
    category: "Principle",
    image: "./images/P04-principle/Pr004-2.webp",
    prompt: "同453~手繪插畫風",
    date: "2026-09-03",
    url: "",
  },
  {
    ...
    title: "回想過去方城之戰-3",
    category: "Principle",
    image: "./images/P04-principle/Pr004-3.webp",
    prompt: "同453~3D動漫版",
    date: "2026-09-03",
    url: "",
  },
  {
    ...
    title: "回想過去方城之戰-4",
    category: "Principle",
    image: "./images/P04-principle/Pr004-4.webp",
    prompt: "同453~LEGO版",
    date: "2026-09-03",
    url: "",
  },
  {
    ...
    title: "一場聚餐三人參與二人掛病號-2",
    category: "Fun",
    image: "./images/F01-Fun/F013-1.webp",
    prompt:
      "<span class='yf3'>利用Perplexity空間~P001-產生文章的資訊圖表提示詞產出後到Arena網站生圖~內容~~~</span>有一天,川董突然打電話來,語氣一如既往地霸氣:「工廠要用三種不同形狀的籃子裝工件,你算一下,每種籃子最多能裝多少個,才能把一天的產量剛好裝完。」 三種籃子,一天產量,還要「剛好裝完」——聽起來像是國中數學應用題,但實際排列組合起來,一點都不輕鬆。 退休後的我,早就練就一身「什麼都先問 AI,絕不自己燒腦」的處世哲學。剛好之前建置的網頁裡,已經算過籃子的長寬高、工件的體積、堆疊方式、可能的空隙耗損——直接搬出來,交給 AI 協助整理一番,三兩下就把答案端出來了。 算完之後,我立刻回覆川董,順便夾帶一句認真提案:「我這樣無償又認真地為公司賣命,您是不是該給我一個頭銜——萬達委外義務志願無條件奉獻專員?」 訊息送出的那一刻,我腦中已經開始自動播放頒獎典禮的畫面:工廠中庭、紅布條、聚光燈,川董站在台上,語重心長地宣布「擇日頒獎表揚」,底下同仁掌聲雷動,我捧著獎狀笑得合不攏嘴。 畫面正演到高潮處,LINE 忽然跳出一則訊息。 川董回:「好。」 一個字。 我這才回過神來,發現自己剛剛已經在辦公桌前,對著手機螢幕做了超過五分鐘的白日夢。 看來這個「萬達委外義務志願無條件奉獻專員」的頭銜,含金量跟那句「好」一樣——精簡、有力,而且大概永遠不會有後續。",
    date: "2026-09-03",
    url: "",
  },
  {
    ...
    title: "",
    category: "Knowledge",
    image: "./images/K01-Knowledge/K002-1.webp",
    prompt: "<span class='yf1'>提示詞找不到了，不過這個隨便寫寫都可以",
    date: "2026-09-03",
    url: "",
  },
  {
    ...
    title: "",
    category: "Knowledge",
    image: "./images/K01-Knowledge/K002-2.webp",
    prompt: "<span class='yf1'>提示詞找不到了，不過這個隨便寫寫都可以",
    date: "2026-09-03",
    url: "",
  },
  {
    ...
    title: "深夜父親的等待-1",
    category: "Life",
    image: "./images/L02-Life/L025-1.webp",
    prompt:
      "<span class='yf3'>利用Perplexity空間~P003-文章用插畫風格呈現，產生提示詞後到Arena網站生圖~內容~~~</span>夜半未歸的焦慮：陽台上沉默的父親(附件1照片)  深夜的焦慮與守候  兒子(附件2照片)平時正常下班約在午夜十二點，但這天直到凌晨兩點多仍未見身影。身為父親，心中難免湧起阵阵擔憂與不安，這份焦慮在寂靜的深夜裡被無限放大，讓人無法安心入眠，只能任由牽掛在心頭盤旋。  陽台上的孤燈與凝望  我獨自站在十一樓的陽台，俯瞰著夜晚孤獨的街道，眼前僅有一盞路燈散發著微弱光芒。在這萬籟俱寂的時刻，那盞孤燈彷彿成了唯一的寄託，我就這樣望穿秋水，在沉默中專注地等待著兒子平安歸來。  無聲卻深沉的父愛  這漫長的等待並非責備，而是源於心底最深處的愛與責任。或許兒子只是因事耽擱，但對於一個父親而言，每一分鐘的遲歸都是煎熬。這份站在陽台上的凝望，雖無言語，卻承載著比夜色更濃、比燈光更暖的親情守護。",
    date: "2026-09-05",
    url: "",
  },
  {
    ...
    title: "深夜父親的等待-2",
    category: "Life",
    image: "./images/L02-Life/L025-2.webp",
    prompt:
      "<span class='yf3'>利用Perplexity空間~P003-文章用插畫風格呈現，產生提示詞後到Arena網站生圖~內容~~~</span>陽台上的沉默守護：比責備更深的親情  深夜陽台上的孤寂守望  兒子平時約午夜十二點下班，但這天直到凌晨兩點多仍未回家。我半夜起身上廁所，發現孩子還沒回來，擔憂之情油然而生，便獨自站在十一樓陽台，望著空蕩街道上唯一的那盞路燈，在寂靜中望穿秋水地等待著那個熟悉的身影出現。  簡短回覆背後的殷切牽掛  忍不住傳了LINE詢問兒子狀況，收到的回覆卻是「不用！趕快去睡覺」。孩子或許以為我只是特意起床關心，但其實這是夜半醒來未見人歸的本能焦慮。那句看似平淡的催促，背後藏著的是父親無法言說、徹夜難安的深切牽掛與心疼。  沉默守護裡最深沉的愛  這份等待從不是責備，而是源於血脈相連的本能關懷。即便被孩子輕描淡寫地回應，那份站在陽台上的凝望依然堅定。在孤燈與夜色之間，父親的愛無需喧嘩，它早已化作深夜裡最安靜卻最溫暖的守護，默默照亮兒子回家的路。",
    date: "2026-09-05",
    url: "",
  },
  {
    ...
    title: "深夜父親的等待-3",
    category: "Life",
    image: "./images/L02-Life/L025-3.webp",
    prompt:
      "<span class='yf3'>利用Perplexity空間~P003-文章用插畫風格呈現，產生提示詞後到Arena網站生圖~內容~~~</span>夜半起身的牽掛：兒子該读懂的無聲父愛  深夜陽台上的孤寂守望  兒子平時約午夜十二點下班，但這天直到凌晨兩點多仍未回家。我半夜起身上廁所，發現孩子還沒回來，擔憂之情油然而生，便獨自站在十一樓陽台，望著空蕩街道上唯一的那盞路燈，在寂靜中望穿秋水地等待著那個熟悉的身影出現。  簡短回覆背後的殷切牽掛  忍不住傳了LINE詢問兒子狀況，收到的回覆卻是「不用！趕快去睡覺」。孩子或許以為我只是特意起床關心，但其實這是夜半醒來未見人歸的本能焦慮。那句看似平淡的催促，背後藏著的是父親無法言說、徹夜難安的深切牽掛與心疼。  沉默守護裡最深沉的愛  這份等待從不是責備，而是源於血脈相連的本能關懷。當媽媽在床上安然酣睡時，是父親在陽台上獨自承受這份煎熬。希望兒子能明白，這盞孤燈下的凝望，比任何言語都更沉重、更真切，那是無需比較卻早已刻進骨子裡的深愛。  ",
    date: "2026-09-05",
    url: "",
  },
  {
    ...
    title: "陪妳看牙的日常",
    category: "Life",
    image: "./images/L02-Life/L025-4.webp",
    prompt:
      "<span class='yf4'>直接給GPT生圖最簡單~~</span>以照片人物爲主角，先開車載老婆去榮總看牙齒門診，然後再開車回到對面停車場停車，再到二樓全家默默等待老婆看完牙齒門診，圖片上方訂定ㄧ個6-8字的溫馨標題繁體中文，圖16:9比例",
    date: "2026-09-05",
    url: "",
  },
  {
    ...
    title: "風雨再大，平安最重要",
    category: "Life",
    image: "./images/L02-Life/L025-5.webp",
    prompt:
      "<span class='yf4'>直接給GPT生圖最簡單~~</span>以照片人物爲主角，在大雨的天氣，貼心提醒兒子雨太大，不要騎摩托車去，可以搭捷運去爸爸晚上再去開車去載你，上方標題訂一個六到八字的溫馨主題16:9比例",
    date: "2026-09-05",
    url: "",
  },
  {
    id: 465,
    title: "舅舅苦等回應記-1~忘記放照片",
    category: "Life",
    image: "./images/L02-Life/L026-1.webp",
    prompt:
      "<span class='yf3'>利用Perplexity空間~P003-文章用插畫風格呈現，產生提示詞後到Arena網站生圖~內容~~~</span>準備好東西給孟洵姊，舅舅苦等回應 滿心期待發出邀請 舅舅非常有心地準備了東西要給孟洵姊，於是在LINE上熱切地發了訊息：「孟洵姊！舅舅有好東西要給你！你下班沒？」字裡行間充滿了長輩對晚輩的關愛與迫不及待想分享喜悅的心情，只盼著對方能趕快看到這份心意。 螢幕前的安靜守候 傳完訊息後，舅舅便一個人靜靜地坐在電腦前，雙眼緊盯著螢幕等待孟洵姊的回應。那份專注而沉默的身影，彷彿將所有的期待都寄託在亮起的螢幕上，只為了不錯過任何一聲提示音或跳出的新訊息。 遲未回覆的癡心等待 然而時間一分一秒過去，孟洵姊始終沒有答覆，可憐的舅舅就這樣對著螢幕癡癡地等。這份無人回應的守候雖然顯得有些孤單，卻也真實映照出他對孟洵姊那份純粹又執著的疼愛，讓人看了既心疼又感動",
    date: "2026-09-05",
    url: "",
  },
  {
    ...
    title: "舅舅苦等回應記-2",
    category: "Life",
    image: "./images/L02-Life/L026-2.webp",
    prompt: "<span class='yf3'>手繪插畫風</span>",
    date: "2026-09-05",
    url: "",
  },
  {
    ...
    title: "舅舅苦等回應記-3",
    category: "Life",
    image: "./images/L02-Life/L026-3.webp",
    prompt: "<span class='yf3'>手繪插畫風</span>",
    date: "2026-09-05",
    url: "",
  },
  {
    ...
    title: "舅舅苦等回應記-4",
    category: "Life",
    image: "./images/L02-Life/L026-4.webp",
    prompt: "<span class='yf3'>3D動漫版</span>",
    date: "2026-09-05",
    url: "",
  },
  {
    ...
    title: "舅舅苦等回應記-5",
    category: "Life",
    image: "./images/L02-Life/L026-5.webp",
    prompt:
      "<span class='yf1'>風雨守候版</span>強調外面風雨，強調舅舅挨餓，強調家中電腦桌前滄桑淒涼",
    date: "2026-09-05",
    url: "",
  },
  {
    ...
    title: "舅舅苦等回應記-6",
    category: "Life",
    image: "./images/L02-Life/L026-6.webp",
    prompt:
      "<span class='yf1'>手繪淒涼守候版</span>改成手繪插畫風，更加淒涼顯示",
    date: "2026-09-05",
    url: "",
  },
  {
    ...
    title: "舅舅苦等回應記-7",
    category: "Life",
    image: "./images/L02-Life/L026-7.webp",
    prompt:
      "<span class='yf1'>吉卜力極淒涼守候版</span>再改成日式吉卜力風格，維持劇本主要內容，比上張更慘更淒涼",
    date: "2026-09-05",
    url: "",
  },
  {
    ...
    title: "舅舅苦等回應記-8",
    category: "Life",
    image: "./images/L02-Life/L026-8.webp",
    prompt:
      "<span class='yf1'>3D動漫明亮反差悲涼版</span>再換成3D動漫版，比上一版還要淒涼還要悲慘，但是色系明亮，淒涼滄桑要更加到位，並且維持劇本主要內容",
    date: "2026-09-05",
    url: "",
  },
  {
    ...
    title: "光頭、刺青、烙腮鬍-1",
    category: "Portrait",
    image: "./images/P02-Portrait/P010-1.webp",
    prompt:
      "<span class='yf3'>圖片直接修改~</span>附件照片為帥氣為帥氣照片，光頭、絡腮鬍、雙臂刺青，短袖，露出強健體魄，臉部要接近照片本人",
    date: "2026-08-22",
    url: "",
  },
  {
    ...
    title: "刺青、烙腮鬍-1",
    category: "Portrait",
    image: "./images/P02-Portrait/P010-2.webp",
    prompt:
      "<span class='yf3'>圖片直接修改~</span>附件照片為帥氣為帥氣照片，絡腮鬍、雙臂刺青，短袖，露出強健體魄，臉部要接近照片本人",
    date: "2026-08-22",
    url: "",
  },
  {
    ...
    title: "刺青、烙腮鬍-2",
    category: "Portrait",
    image: "./images/P02-Portrait/P010-3.webp",
    prompt:
      "<span class='yf3'>圖片直接修改~</span>附件照片為帥氣為帥氣照片，絡腮鬍、雙臂刺青，短袖，露出強健體魄，臉部要接近照片本人",
    date: "2026-08-22",
    url: "",
